...
#include "StdAfx.h"
#include "Extensions/ExtMenuCollectResourceInfo.h"

const char * DefaultPluginVWRIdentifier() { return "ProcessResources"; } // Change this to the name of your plug-in
...
extern "C" Sint32 GS_EXTERNAL_ENTRY plugin_module_main(Sint32 action, void* moduleInfo, const VWIID& iid, IVWUnknown*& inOutInterface, CallBackPtr cbp)
{
	...
	REGISTER_Extension<CollectResourceInfo::CExtMenuCollectResourceInfo>( GROUPID_ExtensionMenu, action, moduleInfo, iid, inOutInterface, cbp, reply );
