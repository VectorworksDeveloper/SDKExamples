...
namespace MockUp
{
	...
	public:
        ...
        virtual MCObjectHandle  VCOM_CALLTYPE ComputePolyWithPerEdgeOffsets(MCObjectHandle polyH, const std::vector<double>& offsets, std::map<size_t, size_t> & vertexMapping, bool bInsertNewOffset = false) {return nullptr;}
		...
		virtual Extension::IWebPaletteFrame*	VCOM_CALLTYPE GetWebPaletteFrame(const VWIID& extensionIID) {return nullptr;}
		...
		virtual bool VCOM_CALLTYPE EnumerateVWResources(const char* resourceFolderIdentifier, bool recursive, std::function<void(const TXString& resourceIdentifier)> callback) { return false; }
        
        virtual size_t VCOM_CALLTYPE PolylineCurveCountBetweenTwoCornerVertices(MCObjectHandle h, size_t index1, size_t index2) { return 0; };
		...
		virtual void VCOM_CALLTYPE TransferAuxList(MCObjectHandle hSource, MCObjectHandle hDestination, bool isForDuplication, bool transferUserDataNodes){ }
	};
}
