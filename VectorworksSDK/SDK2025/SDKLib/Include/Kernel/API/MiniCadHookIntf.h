...
// //Boolean																// the core will automatically move imported styles to the default folder got from OnGetStyleFolder function.
													//						//
//--------------------------------------------------//----------------------//-------------------------------------------------------------------------------------------------
const ObjectPropID kObjPropCustomHanding = 107;		//			NO			// Allow a tool to opt into custom handing which included flipping and mirroring
//--------------------------------------------------//----------------------//-------------------------------------------------------------------------------------------------
...
//--------------------------------------------------//----------------------//-------------------------------------------------------------------------------------------------
const ObjectPropID kObjPropCustomHandingContainer = 111;//		NO			// Allow an object to occupy Door and Window Assembly Units by implementing IAssemblyUnitObject
//--------------------------------------------------//----------------------//-------------------------------------------------------------------------------------------------


const ObjectPropID kLastObjXProp = kObjPropCustomHandingContainer;// last property ID
...
const TInternalID kMAX_INTERNAL_INDEX					=	kInternalID_RecessCW;
