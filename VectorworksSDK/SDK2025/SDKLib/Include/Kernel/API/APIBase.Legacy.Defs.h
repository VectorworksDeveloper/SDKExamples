...
///////////////////////////////////////////
	...
	extern "C" short GS_CALLBACK GS_GetObjectType(CallBackPtr, MCObjectConstHandle h);
		/*
...
///////////////////////////////////////////
	...
	extern "C" MCObjectHandle GS_CALLBACK GS_FindDataObject(CallBackPtr, MCObjectConstHandle owner, OSType tag);
		/*
...
///////////////////////////////////////////
	...
	extern "C" MCObjectHandle GS_CALLBACK GS_CreateGroup(CallBackPtr, bool isTemporary = false);
		/*
	...
	extern "C" MCObjectHandle GS_CALLBACK GS_CreateLocus(CallBackPtr, const WorldPt& location, bool isTemporary = false);
		/*
...
///////////////////////////////////////////
	...
	extern "C" Sint32 GS_CALLBACK GS_RunLayoutDialog(CallBackPtr, Sint32 dialogID, GS_EventHandlerProcPtr handleEvent, void* env, const TXString& contextualHelpID);
		/*
