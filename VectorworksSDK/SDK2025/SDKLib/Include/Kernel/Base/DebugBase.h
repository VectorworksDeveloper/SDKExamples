...
//	Define name								File Value				fID4                   fID3                   fID2                   fID1                   flags    onlyIfActiveUser  sendOwn
	...
	#define kMao				TProgrammer("Charlene",				0x0000000000000000ULL, 0x0000000000000000ULL, 0x0000000000000000ULL, 0x0000000000100000ULL, 0,       false,            false)
	...
	#define kCPHsiao			TProgrammer("CPHsiao",				0x0000000000000000ULL, 0x0000000000000000ULL, 0x0000000000000008ULL, 0x0000000000000000ULL, 0,       false,            true)
	...
	#define kZSarver			TProgrammer("ZSarver",				0x0000000000000000ULL, 0x0000000000000000ULL, 0x0000000000020000ULL, 0x0000000000000000ULL, 0,       false,            true)
	...
	#define kXYu			    TProgrammer("XYu",				    0x0000000000000000ULL, 0x0000000000000000ULL, 0x0000002000000000ULL, 0x0000000000000000ULL, 0,       false,            true)
	...
	#define kDShores			TProgrammer("DShores",				0x0000000000000000ULL, 0x0000000000000000ULL, 0x0000040000000000ULL, 0x0000000000000000ULL, 0,       false,            true)
	...
	#define kIMarinova			TProgrammer("IMarinova",			0x0000000000000000ULL, 0x0000000000000000ULL, 0x0004000000000000ULL, 0x0000000000000000ULL, 0,       false,            true)
	#define kSMilev				TProgrammer("SMilev",				0x0000000000000000ULL, 0x0000000000000000ULL, 0x0008000000000000ULL, 0x0000000000000000ULL, 0,       false,            true)
	#define kKDyulgerov			TProgrammer("KDyulgerov",			0x0000000000000000ULL, 0x0000000000000000ULL, 0x0010000000000000ULL, 0x0000000000000000ULL, 0,       false,            true)
	...
	#define kJvonHodenberg		TProgrammer("JanineVonHodenberg",	0x0000000000000000ULL, 0x0000000000000000ULL, 0x2000000000000000ULL, 0x0000000000000000ULL, 0,       false,            true)
...
// Release version definitions:
	...
	#define kJvonHodenberg		__ignore_programmer
...
Sint32 GSDEBUG_EXPORT _AssertEx(const TProgrammer & inProgrammer, const char * inAssertFile, Sint32 inAssertLine, const char * inMessage, ...);
	...
	Sint32 _AssertNotVolatile(const TProgrammer& toWhom, const char* file, Sint32 line, const char* ptrName, const void* ptr);
...
// These are the Mac ASSERT macros.
	...
	#define ASSERTPSTRING(toWhom, ps, min, max) \
				((void)_AssertValidPString(true,toWhom,THIS_FILE,__LINE__,#ps,(ConstGSStringPtr)ps,min,max))
...
#define VERIFYPSTRING(toWhom, ps, min, max)  \
			::_AssertValidPString(false,toWhom,THIS_FILE,__LINE__,#ps,(ConstGSStringPtr)ps,min,max)
