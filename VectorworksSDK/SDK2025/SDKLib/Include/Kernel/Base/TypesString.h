...
public:
	...
	TXString(const std::u16string& src);
	...
	TXString(const char16_t* src);
	TXString(const char16_t* src, size_t len, ELengthCheck eLengthCheck = ELengthCheck::eYes);
	...
	explicit TXString(char16_t ch, size_t count = 1);
	...
	TXString& operator=(const char16_t* src);
	...
	TXString& operator=(const char16_t ch);
	...
	TXString& Insert(size_t pos, const char16_t* src);
	...
	TXString& Insert(size_t pos, const char16_t ch);
	...
	operator const char16_t*() const;			// UTF-16
	...
	const char16_t* GetChar16Ptr() const { return (operator const char16_t*()); }
	...
	std::u16string GetStdU16String() const;
...
public:
	...
	void CopyInto(char16_t* dst, size_t bufElemSize) const;
