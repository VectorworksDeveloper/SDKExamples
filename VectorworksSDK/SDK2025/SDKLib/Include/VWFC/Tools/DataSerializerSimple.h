...
namespace VWFC
{
	namespace Tools
	{
		...
		public:
			...
			// Use Load() when you need the whole data. It will copy it in a tree with easy access.
			// If you need to access just a piece of data, then use directly the GetValueXXX() functions
			// without loading. In term of performance, it will be better.
			bool		Load();
