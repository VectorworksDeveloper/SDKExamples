...
namespace VWFC
{
	...
	namespace VWObjects
	{
		...
		public:
			void			AddVertex(double x, double y, bool bRecalcBounds=true, VectorWorks::TEditContext editContext=nullptr);
			void			AddVertex(const VWPoint2D& pt, bool bRecalcBounds=true, VectorWorks::TEditContext editContext=nullptr);

			void			AddCornerVertex(double x, double y, bool bRecalcBounds=true, VectorWorks::TEditContext editContext=nullptr);
			void			AddCornerVertex(const VWPoint2D& pt, bool bRecalcBounds=true, VectorWorks::TEditContext editContext=nullptr);
			void			InsertCornerVertex(size_t beforeIndex, const VWPoint2D& pt, bool bRecalcBounds=true);
			void			SetCornerVertex(size_t index, const VWPoint2D& pt, bool bRecalcBounds=true, VectorWorks::TEditContext editContext=nullptr);

			void			AddBezierVertex(const VWPoint2D& pt, bool bRecalcBounds=true, VectorWorks::TEditContext editContext=nullptr);
			void			InsertBezierVertex(size_t beforeIndex, const VWPoint2D& pt, bool bRecalcBounds=true);
			void			SetBezierVertex(size_t index, const VWPoint2D& pt, bool bRecalcBounds=true, VectorWorks::TEditContext editContext=nullptr);

			void			AddCubicVertex(const VWPoint2D& pt, bool bRecalcBounds=true, VectorWorks::TEditContext editContext=nullptr);
			void			InsertCubicVertex(size_t beforeIndex, const VWPoint2D& pt, bool bRecalcBounds=true);
			void			SetCubicVertex(size_t index, const VWPoint2D& pt, bool bRecalcBounds=true, VectorWorks::TEditContext editContext=nullptr);

			void			AddArcVertex(const VWPoint2D& pt, double dRadius, bool bRecalcBounds=true, VectorWorks::TEditContext editContext=nullptr);
			void			InsertArcVertex(size_t beforeIndex, const VWPoint2D& pt, double dRadius, bool bRecalcBounds=true);
			void			SetArcVertex(size_t index, const VWPoint2D& pt, double dRadius, bool bRecalcBounds=true, VectorWorks::TEditContext editContext=nullptr);

			void			AddRadiusVertex(const VWPoint2D& pt, bool bRecalcBounds=true, VectorWorks::TEditContext editContext=nullptr);
			void			InsertRadiusVertex(size_t beforeIndex, const VWPoint2D& pt, bool bRecalcBounds=true);
			void			SetRadiusVertex(size_t index, const VWPoint2D& pt, bool bRecalcBounds=true, VectorWorks::TEditContext editContext=nullptr);

			void			GetPolygon(VWPolygon2D& outPoly) const;
			void			GetPolygon(VWPolygon3D& outPoly) const;
			VWPolygon2D		GetPolygon() const;
			...
			void			SetVertexPoint(size_t index, const VWPoint2D& pt, VectorWorks::TEditContext editContext=nullptr);
			...
			// segmentation
			MCObjectHandle	CreatePolylineWithSegmentedArcs() const;
		
		// tool
		public:
			// Return true if the specified object handle is 2D locus
			static bool		IsPoly2DObject(MCObjectConstHandle hObj);
			static bool		IsPolygon2DObject(MCObjectConstHandle hObj);
			static bool		IsPolyline2DObject(MCObjectConstHandle hObj);
