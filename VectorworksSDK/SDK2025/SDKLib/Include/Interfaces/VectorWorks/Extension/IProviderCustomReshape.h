...
namespace VectorWorks
{
	namespace Extension
	{
		...
		public:
			...
			virtual bool	VCOM_CALLTYPE IsSupportingMarqueeSelection() { return false; }
			virtual void	VCOM_CALLTYPE ValidateReshapeData(SReshapeData& ioReshapeData){};
			virtual bool	VCOM_CALLTYPE IsSupportingHeterogenSelection() { return false; }
			virtual void	VCOM_CALLTYPE HandleMoveSelectionEvent(const ToolMoveSel2DMessage& eventData) {}
		};
	}
}
