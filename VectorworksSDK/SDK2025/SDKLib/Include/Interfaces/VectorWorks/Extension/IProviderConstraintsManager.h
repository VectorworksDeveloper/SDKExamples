	...
	namespace Extension
	{
		...
		class DYNAMIC_ATTRIBUTE IProviderConstraintsManager : public IEventSink
		{
			public:
				...
				// Return true if you want non constrained texts and dynamic objects to also resize the boundary
				virtual bool							VCOM_CALLTYPE NonConstrainedObjectsResizeBounds() { return false; }
