...
namespace VectorWorks
{
	namespace Extension
	{
		...
		public:
			...
			virtual bool VCOM_CALLTYPE		ReverseTranslate2022(MCObjectHandle h) = 0;	// return true if this object is to be preserved by reverse translate to 2022
			virtual bool VCOM_CALLTYPE		ReverseTranslate2023(MCObjectHandle h) { return true; };	// return true if this object is to be preserved by reverse translate to 2023
			virtual bool VCOM_CALLTYPE		ReverseTranslate2024(MCObjectHandle h) { return true; };	// return true if this object is to be preserved by reverse translate to 2023
