...
namespace VectorWorks
{
	namespace Extension
	{
		...
		public:
			...
			virtual void		VCOM_CALLTYPE	AddFormatLocalization(const TXString& formatName, const TXString& localizedName, const std::vector<TXString>& arrLocalizedFields, const TMapPopupLocalizationInfo& mapPopuptLocalization = {}) = 0;
		};
