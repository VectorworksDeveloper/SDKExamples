		...
		*/
		...
		public:
			...
			*/
			...
			virtual VCOMError VCOM_CALLTYPE GetProtectionFlags(const TXString& inIdentifier, VectorWorks::Licensing::ModuleSet& modules, VectorWorks::Licensing::LicenseFlagSet& licenseFlags, VectorWorks::Licensing::LicenseTypeSet& licenseTypes) = 0;
