...
namespace VectorWorks
{
	...
	struct SRefreshLibrariesOptions
	{
		...
		bool fUpdateSubscriptionLibs = true;
		bool fUpdateUserLibs = true;
		bool fUpdateWorkgroupsLibs = true;
		bool fUpdateFavorites = true;

		bool NeedsUpdate() { return (fUpdateVWLibs || fUpdateVWOnlineLibs || fUpdateSubscriptionLibs || fUpdateUserLibs || fUpdateWorkgroupsLibs || fUpdateFavorites);}
	...
	public:
		...
		fType(kVSPluginMenu), fVersionCreated(0), fVersionModified(0), fVersionRetired(0), fProtectionProducts(0), fProtectionModules(0), fIcon(VectorWorks::UI::IID_Icon)
		{
			fUniversalName[0] = 0;
			fLocalizedName[0] = 0;
			fCategory[0] = 0;
