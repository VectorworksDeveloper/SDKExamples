...
namespace VectorWorks
{
	namespace Units
	{
		...
		public:
			...
			virtual VCOMError				VCOM_CALLTYPE EnableRoundFractionsToDecimal(bool value) = 0;
			virtual bool					VCOM_CALLTYPE IsEnabledRoundFractionsToDecimal() = 0;
			...
			virtual TXString				VCOM_CALLTYPE GetSquareUnitMark() = 0;
