...
public:		
	...
	virtual	void		VCOM_CALLTYPE	SetNameOfField( short fieldIndex, const TXString& nameOfField) = 0;
...
public:
	...
	virtual void		VCOM_CALLTYPE	SetIsReadonlyNonText_TS(bool isReadonly) = 0;
...
public:
	...
	virtual Boolean		VCOM_CALLTYPE	ConvertFieldStyleForDimensionField(short fieldIndex, EFieldStyle fieldStyle) = 0; 
