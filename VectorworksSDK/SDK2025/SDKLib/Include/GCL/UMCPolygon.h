...
// fNumVerts and some "index" variables were Coords, or longs, and as far as i know should all be shorts.
{
	...
	public:
		...
		void GS_API AddVertex(const WorldPt& p, VectorWorks::TEditContext editContext);
		void AddVerticesToPoly();
		bool SelefIntersectingPolygon();
		
		void GS_API SetVertex(short vertexNum, const WorldPt& vertex, VectorWorks::TEditContext editContext);
