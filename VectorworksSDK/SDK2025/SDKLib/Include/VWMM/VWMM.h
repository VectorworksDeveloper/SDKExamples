...
protected:
	...
	void MemoryStat_GetSlotBoundsStr(char *str, size_t slotNum) const; // given a slot and a buffer, fill buffer with a string such as "100-250" based on the range stored in slot
