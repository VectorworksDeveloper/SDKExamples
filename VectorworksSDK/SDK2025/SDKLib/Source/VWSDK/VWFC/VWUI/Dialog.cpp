...
void VWDialog::VerifyControlIsValid(VWControl* pControl)
{
	...
	VERIFYMSG(kAAntonini, valid, "Trying to tie a VWControl instance to a Layout Manager control with a different component type");
}
...
bool VWDialog::GetStyleControlType(TControlID controlID, EPluginStyleParameter& styleType)
{
	...
	if ( found = iter != fStyleControlMap.end() )
	{
