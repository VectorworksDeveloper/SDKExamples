			...
			case WM_PAINT: {
					if ( fbDefaultPaint ) {
						...
						{ // keep this block so 'VWCustomCtrlDC' could be deleted before OnAfterPaint call
							...
							VWCustomCtrlDC	backbufferDC(fCustomCtrlRect.Width(), fCustomCtrlRect.Height());
							OnPaint(backbufferDC);
							dc.BitBlt(ViewRect(0, 0, fCustomCtrlRect.Width(), fCustomCtrlRect.Height()), backbufferDC, ViewPt(0, 0));
