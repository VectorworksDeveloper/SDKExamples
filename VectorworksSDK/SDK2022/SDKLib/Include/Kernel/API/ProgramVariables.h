...
//	varDefaultImageFillTessellate		= 525,	// bool		read/write - UNIMPLEMENTED. Indicates if image fill is tessellated.
	...
	varDTMExtendedModifiers				= 1108, // Boolean read/write - true if the Site Model will enable the extended site modification workflows, and disable the old modifiers
