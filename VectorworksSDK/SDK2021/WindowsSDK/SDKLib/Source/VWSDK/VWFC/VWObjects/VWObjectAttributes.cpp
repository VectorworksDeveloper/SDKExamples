...
void VWObjectAttr::ApplyToObject(MCObjectHandle h) const
{
	...
	destObjAttr.SetPenForeColor( this->GetPenForeColor() );
	destObjAttr.SetPenBackColor( this->GetPenBackColor() );
	destObjAttr.SetPenPattern( this->GetPenPattern() );
	destObjAttr.SetFillForeColor( this->GetFillForeColor() );
	destObjAttr.SetFillBackColor( this->GetFillBackColor() );
