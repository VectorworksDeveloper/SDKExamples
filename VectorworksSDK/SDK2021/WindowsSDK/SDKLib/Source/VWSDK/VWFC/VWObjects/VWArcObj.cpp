...
void VWArcObj::GetAngles(double& outStartAngleDeg, double& outSweepAngleDeg)
{
...
void VWArcObj::GetRadius(double& outRadiusX, double& outRadiusY)
{
...
void VWArcObj::GetInfo(VWPoint2D& outCenter, double& outStartAngleDeg, double& outSweepAngleDeg, double& outRadiusX, double& outRadiusY)
{
	WorldPt	centerPt;
