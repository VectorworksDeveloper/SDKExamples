...
namespace VWFC
{
	...
	namespace VWObjects
	{
		...
		public:
			...
			void			GetAngles(double& outStartAngleDeg, double& outSweepAngleDeg);
			double			GetRadius() const;
			void			GetRadius(double& outRadiusX, double& outRadiusY);
			void			GetInfo(VWPoint2D& outCenter, double& outStartAngleDeg, double& outSweepAngleDeg, double& outRadiusX, double& outRadiusY);
