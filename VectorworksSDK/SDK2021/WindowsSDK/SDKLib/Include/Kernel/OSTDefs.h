...
#define OST_CreatorCode	'VW26'	// VectorWorks 25 Application Creator Code; See VectorWorks.r, "plist" discussion for more information regarding changing creator codes.
...
// ***NOTE*** if the file version has changed. Add a new define of the form, DTXX for the new version. Change OST_StationeryFileType to the new version.
