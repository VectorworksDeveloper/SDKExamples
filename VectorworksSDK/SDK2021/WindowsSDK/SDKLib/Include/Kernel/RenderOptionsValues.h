...
#ifndef _RENDEROPTIONSVALUES_
#define _RENDEROPTIONSVALUES_
...
const short kGLUseTextures			= 0;
const short kGLTessellationDetail	= 1;
const short kGLUseNURBS				= 2;
const short kGLUseAntiAliasing		= 3;
const short kGLDrawEdges			= 4; 
const short kGLUseShadows			= 5;
const short kGLOnGroundOnly			= 6;
const short kGLShadowSoftness		= 7;
const short kGLUseColors			= 9;
const short kGLCreaseAngle			= 10;
const short kGLEdgeThickness		= 11;
