/*
     ...
     Contains:   Definition of basic Macintosh data types borrowed from MacTypes.h (QuickTime 6.0.2)
	 QTRemoval 
 
*/
#ifndef __MACTYPESQT__
#define __MACTYPESQT__
