...
//
//	Declares a set of useful vector-math functions.
//
...
// These should be in a different header XXX_JDW_MISC
...
const extern double_gs kDegreesPerRadian;	// 180.0 / PI;
const extern double_gs kRadiansPerDegree;	// PI / 180.0;
