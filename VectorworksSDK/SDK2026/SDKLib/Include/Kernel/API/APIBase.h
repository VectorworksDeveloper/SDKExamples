...
/////////////////////////////////////////////////////////////////////////////////////////
// The file "/AppSource/Source/Include/User.h" is a file that each person that builds VectorWorks can have. The
...
//
// If you need to create a User.h file, do this:
//
// Create a file in your branch /AppSource/Source/Include/User.h and add
// the following to the file:
//
// #define MyName 1
//
// where MyName is the login name you use for the company file servers and
// the SourceSafe databases. (This should be the same name.) See #developers channel in stack if you
...
//        #endif
//
// Note: ExternalUser.h is no longer used as it was never officially and predictable included
//		 Thrid-party developers, you can put User.h in your SDK folder: \SDKLib\Include\Kernel\User.h
// 
#if BUG && __has_include("User.h")
	#include "User.h"
#elif __has_include("../User.h")
	#include "../User.h"
#elif __has_include("../../../../Include/User.h")
...
////////////////////////
	...
	typedef GSConstHandle MCObjectConstHandle;
#endif
