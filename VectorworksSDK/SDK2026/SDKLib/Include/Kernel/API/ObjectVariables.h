...
const short ovDimUnit						= 1751; // short - Public for VS
// The dimension unit index. A value of 0 indicates it is using document units.
// A value greater than zero indicates it is using a custom dimension unit setting.
// If it is an angular dimension, a value of n means it is using the nth angular
// unit setting, else if not an angular dim, a value of n means it is using the 
// nth linear unit setting.
...
const short ovWSImageBoxAlignment		= 105;		// Sint16	- read/write - OIP box alignment / anchor point for worksheet images  - Public for VS
...
// Referenced Layer specific
// ----------------
const short ovGuestLayerHasRelativePath	= 163;		// Boolean, read-only - returns true when layer is referenced and file path is relative - Public for VS
...
// Cavity selectors 199-350, 690} obsolete since 2005, removed 2024.
// update VSConstantParameterIsObsolete if any are reassigned.
...
// --------------
const short ovViewportPerspectiveType		= 999;		// short	read/write - the viewport perspective subtype (std, 2pp) - Public for VS
...
const short ovViewportAutoScaleMarkers		= 1083;	// Boolean read/write
const short ovViewportDataVizSchemes		= 1084; // UuidStorageList read/write
...
const short ovArchStyleMark								= 1207; // TXString		read/write - The mark (insertion option) - Public for VS
const short ovArchStyleDescription						= 1208; // TXString		read/write - The description (insertion option) - Public for VS
const short ovArchStyleFunction							= 1209; // TXString		read/write - The function (insertion option) - Public for VS
const short ovArchStyleExterior							= 1210; // Boolean		read/write - The exterior setting (insertion option) - Public for VS
const short ovArchStyleLoadBearing						= 1211; // Boolean		read/write - The load-bearing setting (insertion option) (Wall Style and Slab Style only) - Public for VS
const short ovArchStyleFireRating						= 1212; // TXString		read/write - The fire rating (insertion option) - Public for VS
const short ovArchStyleCombustibleConstruction			= 1213; // Boolean		read/write - The combustible construction setting (insertion option) (Wall Style and Slab Style only) - Public for VS
const short ovArchStyleCompartmentation					= 1214; // Boolean		read/write - The compartmentation setting (insertion option) (Wall Style and Slab Style only) - Public for VS
const short ovArchStyleUValue_OBSOLETE					= 1215; // Obsolete
const short ovArchStyleRValue_OBSOLETE					= 1216; // Obsolete
const short ovArchStyleAcousticRating					= 1217; // TXString		read/write - The acoustic rating (insertion option) (Wall Style and Slab Style only) - Public for VS
const short ovArchStyleCostIndexSystem					= 1218; // TXString		read/write - The cost index system (insertion option) - Public for VS
const short ovArchStyleCostIndexCode					= 1219; // TXString		read/write - The cost index code (insertion option) - Public for VS
const short ovArchStyleModel							= 1220; // TXString		read/write - The model (insertion option) - Public for VS
const short ovArchStyleManufacturer						= 1221; // TXString		read/write - The manufacturer (insertion option) - Public for VS
...
// The getters for these properties return values in display units. See VWMaterialObj for getters that return values in base units.
// The setters for these properties expect the passed values to be in base units.
...
const short ovMaterialEmbodiedCarbonUnitType			= 1615;
//Embodied Carbon Manufacturer Flag
const short ovMaterialEmbodiedCarbonManufFlag			= 1616;
...
const short ovGraphicLegendCopyObject					= 1645; // MCObjectHandle read, only valid during PIO reset for GraphicLegend
const short ovGraphicLegendOriginalObject				= 1646; // MCObjectHandle read/write, only valid during PIO reset for GraphicLegend
const short ovGraphicLegendViewType						= 1647; // Sint16 read/write (values are same as EViewTypes), only valid during PIO reset for GraphicLegend
const short ovGraphicLegendBgRenderMode					= 1648; // Sint16 read/write (values are same as TRenderMode), only valid during PIO reset for GraphicLegend
const short ovGraphicLegendFgRenderMode					= 1649; // Sint16 read/write (values are same as TRenderMode), only valid during PIO reset for GraphicLegend
const short ovGraphicLegendDoorWindowClosed				= 1650; // Boolean read/write, only valid during PIO reset for GraphicLegend

const short	ovFontTableNumItems							= 1655; //	short, not for public use

const short ovPaintUsesAlpha 							= 1656; // Boolean read/write paint node uses alpha channel for draw
const short ovPaintLockProportions 						= 1657; // Boolean read/write paint node lock width/height proportions
