...
enum EFolderSpecifier {
	...
	//kDefaultConnectCADDataFolder			= 343, // Removed in VW2026. Contents moved in kDefaultRecordFormatsFolder
   ...
   // For now, we're not adding the black symbol folders (e.g. Fixtures Exterior, Foundations, Roof Access, etc.)
	...
	kPlants2DTopPlan						= 387,
	kPlantsElevImageProps					= 388,
	kPlantsModels							= 389,
	kPlantsElevImages						= 390,
	kPlantaToolData							= 391,
	// 392
	...
	// folder for styles of the Door and Window Assembly Object
	kObjectStylesDoorAndWindowAssemblyFolder	= 435,
	...
	kObjectStylesVideoLEDWallFolder				= 447,
	kEntertainmentVideoLEDPanelsFolder			= 448,

	kEntertainmentHardwareGroundFolder			= 449,

	kEntertainmentHardwareHangingFolder			= 450,
	kEntertainmentHardwareClampsFolder			= 451,
	kEntertainmentHardwarePipeClampsFolder		= 452,
	kEntertainmentHardwareSlidingTeesFolder		= 453,

	kEntertainmentHardwarePipesFolder			= 454,
	kEntertainmentOnePieceSideArmsFolder		= 455,
	kEntertainmentSideArmPipesFolder			= 456,

	kDefaultSustainabilityFolder				= 457,	// Folder with record formats representing sustainability frameworks

	kEntertainmentVideoLEDAccessoriesFolder		= 458,
	kExistingTree2DCanopyFolder					= 459,
	kExistingTree3DCanopyFolder					= 460,
	kExistingTree2DTrunkFolder					= 461,
	kStakeDataTagStyleFolder					= 462,

	kEntLightingFolder							= 463,
	kEntAudioFolder								= 464,
	kEntRiggingFolder							= 465,
	kEntVideoLEDFolder							= 466,
	
	// folders for styles of Door and Window Assembly related objects
	kDoorAndWindowAssemblyObjectsFolder			= 467,
	kAssemblyLintelFolder						= 468,
	kAssemblyMullionFolder						= 469,
	kAssemblyPanelFolder						= 470,
	kAssemblyShutterFolder						= 471,
	kAssemblySillFolder							= 472,
	kAssemblyStoolFolder						= 473,
	kAssemblyTrimFolder							= 474,
	kConnectCADDeviceFolder						= 475,

	kEntVideoScreenCasing1610Folder				= 476,
	kEntVideoScreenTVStandModelsFolder			= 477
};
