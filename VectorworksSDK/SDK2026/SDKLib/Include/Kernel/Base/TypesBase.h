...
inline bool setmember(T1 const& x, Args const&... options)
{
	return ( ( x == options ) || ... );
}
...
typedef const char *const * GSConstHandle; // GSConstHandle is a pointer to a const pointer to a const char
//        |        |      |       |
//        |        |      |   GSConstHandle is...
//        |        |   a pointer to...
//        |   a const pointer to...
