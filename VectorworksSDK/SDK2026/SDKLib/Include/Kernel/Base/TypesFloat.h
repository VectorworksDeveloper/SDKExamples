...
const extern float kNearlyEqualEpsilonForFloats;
...
//------------------------------------------------------------
//
// Copied from DoublesAreNearlyEqual
//
force_inline Boolean FloatsAreNearlyEqual(const float& n1, const float& n2,
	float epsilon = kNearlyEqualEpsilonForFloats)
{
	float abs_n1 = fabs(n1);
	float abs_n2 = fabs(n2);
	float abs_n1n2 = fabs(n1 - n2);
