...
#if BUG
void BugVerifyTransformMatrix(const TransformMatrix& matrix, bool allow2DOrtho = false);
#endif

inline void VerifyTransformMatrix(const TransformMatrix& BUG_ONLY(matrix), bool allow2DOrtho = false)
{
#if BUG
	BugVerifyTransformMatrix(matrix, allow2DOrtho);
#endif
}
