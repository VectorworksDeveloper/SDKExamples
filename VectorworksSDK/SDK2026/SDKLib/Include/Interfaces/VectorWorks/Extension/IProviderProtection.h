...
namespace VectorWorks
{
	namespace Extension
	{
		...
		public:
			...
			virtual Licensing::LicenseFlagSet VCOM_CALLTYPE GetLicenseFlags() { return {}; };
			virtual Licensing::ApplicationModeSet VCOM_CALLTYPE GetLicenseTypes() { return {}; };
			virtual Licensing::ModuleSet	  VCOM_CALLTYPE GetModules()	  { return {}; };
			
			virtual bool VCOM_CALLTYPE IsLDFLicensed() { return false; }
		};
