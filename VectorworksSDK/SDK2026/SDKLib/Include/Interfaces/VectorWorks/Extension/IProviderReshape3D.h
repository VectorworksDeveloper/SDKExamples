...
namespace VectorWorks
{
	namespace Extension
	{
		...
		public:
			...
			// VW2024
			virtual bool VCOM_CALLTYPE		IsDrawAllowedWithoutPoints() { return false; }
			virtual bool VCOM_CALLTYPE		IsMouseMoveAllowedWithoutPoints() { return false; }
			virtual bool VCOM_CALLTYPE		IsWorkingWithHotSpots() { return true; }
			virtual bool VCOM_CALLTYPE		AlwaysUseLegacyCursor() { return false; }

			// VW2025
			// Return this in GetCursorID in order to get GetCursorSpecifier called afterwards
			static const Sint32 kCursorIDGetCursorSpecifier = -1;

			virtual TXString VCOM_CALLTYPE	GetCursorSpecifier() { return ""; }
		};
	}
}