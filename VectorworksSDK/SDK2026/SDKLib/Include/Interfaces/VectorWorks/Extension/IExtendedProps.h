...
namespace VectorWorks
{
	namespace Extension
	{
		...
		struct SLoadData
		{
			...
			// VW2026
			bool		fEnableAttaching;			// if true, the object will be able to be attached.
		};
		...
		public:
			...
			virtual bool					VCOM_CALLTYPE CallParametric(CodeRefID objectID, MCObjectHandle h, ParametricMessage& message, Sint32& outResult) = 0;

		// VW2023
		public:
			virtual TXStringArray			VCOM_CALLTYPE GetAvailableObjectsForEquipmentItemAttach() = 0;

		// VW2025
		public:
			virtual TXStringArray			VCOM_CALLTYPE GetAllUnivNamesWithXProp( ObjectPropID xProp ) = 0;
		};
