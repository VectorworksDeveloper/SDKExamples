...
namespace VectorWorks
{
	namespace IFCLib
	{
		...
		enum class EMappingCategory : Sint32
		{
			eClassBasedLegacy,
			eSymbolDef,
			ePlugInThirdPartyLegacy,
			ePlugInBuiltInLegacy,
			eIfcEntity,
			eCriteriaBased,
			eParametricObjects,
			eModelHierarchy,
		...
		//-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
		enum class EExportIFCPane : Sint16
		{
			ExportOptions			= 1,
			ProjectData				= 2,
			AuthorData				= 3,
		...
		class DYNAMIC_ATTRIBUTE IIFCSupport : public IImportReference
		{
		public:
			...
			virtual VCOMError VCOM_CALLTYPE Import(IFileIdentifierPtr& fileID, const bool bShowUI, EImportModeRef importMode) override = 0;
			...
			virtual VCOMError VCOM_CALLTYPE IFC_ClearIFCInfo(MCObjectHandle hObject, bool bDoUndo = true) = 0;
			...
			typedef std::vector<TXString>					TCOBieColumsArray;
			typedef std::pair<TXString, TCOBieColumsArray>	TCOBieWorksheetDef;
			virtual void VCOM_CALLTYPE IFC_GetCOBieWorksheets(std::vector<TCOBieWorksheetDef>& outArray) = 0;

			virtual void VCOM_CALLTYPE Style_GetArchitecturalFields(std::vector<std::pair<TXString,TXString>>& outUniv2LocNameFields) = 0;
			virtual void VCOM_CALLTYPE Style_GetGeneralFields(std::vector<std::pair<TXString,TXString>>& outUniv2LocNameFields) = 0;
			virtual bool VCOM_CALLTYPE Style_GetFieldValue(MCObjectHandle h, const TXString& fieldUnivName, VWVariant& outResult, bool useDocumentUnits = false) = 0;
			virtual bool VCOM_CALLTYPE Style_IsFieldEditable(MCObjectHandle h, const TXString& fieldUnivName) = 0;
			virtual bool VCOM_CALLTYPE Style_SetValue(MCObjectHandle h, const TXString& fieldUnivName, const TXString& value) = 0;

			virtual VCOMError VCOM_CALLTYPE	ExportObject(TXString& outPartialModel, const std::vector<MCObjectHandle>& arrhObject, bool bDoInstancesOnly = false) = 0;
			virtual VCOMError VCOM_CALLTYPE	IFC_ExportNoUI(IFileIdentifier* pFileID) = 0;

			// VW 2022 -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
			virtual VCOMError VCOM_CALLTYPE IFC_CreateZSG(EZSGSelector selector, const TXString& ZSGName) = 0;
			virtual VCOMError VCOM_CALLTYPE IFC_SetZSGFieldValue(EZSGSelector selector, const TXString& ZSGName, const TXString& fieldName, const TXString& fieldValue) = 0;
			virtual VCOMError VCOM_CALLTYPE IFC_GetZSGFieldValue(EZSGSelector selector, const TXString& ZSGName, const TXString& fieldName, TXString& outFieldValue) = 0;
			virtual VCOMError VCOM_CALLTYPE IFC_AttachPSetToZSG(EZSGSelector selector, const TXString& ZSGName, const TXString& psetName) = 0;
			virtual VCOMError VCOM_CALLTYPE IFC_SetZSGPSetFieldValue(EZSGSelector selector, const TXString& ZSGName, const TXString& psetName, const TXString& psetField, const TXString& psetFieldValue) = 0;
			virtual VCOMError VCOM_CALLTYPE IFC_GetZSGPSetFieldValue(EZSGSelector selector, const TXString& ZSGName, const TXString& psetName, const TXString& psetField, TXString& outFieldValue) = 0;

			// VW 2022 SP3 -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
			virtual VCOMError VCOM_CALLTYPE IFC_GetIFCMetaData(MCObjectHandle hObject, TXStringArray& outArrEntry, TXStringArray& outArrProperty, TXStringArray& outArrType, TXStringArray& outArrValue) = 0;

			// VW 2023 ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
			virtual VCOMError VCOM_CALLTYPE IFC_GetIFCDoc(EIFCSupportSchema docScheme, IfcModel::CIfcDocument** outDoc) = 0;
			virtual VCOMError VCOM_CALLTYPE IFC_LoadCustomPSets() = 0;
			virtual VCOMError VCOM_CALLTYPE IFC_ExportFileWithUI(bool bExportSingleObjects, TXString* pFileName = nullptr) = 0;

			// VW 2023 SP2 ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
			virtual VCOMError VCOM_CALLTYPE IFC_ExportHeaderAsJson(nlohmann::json& outJsonHeader) = 0;
			virtual VCOMError VCOM_CALLTYPE IFC_GetLengthUnit(TXString& outUnitName) = 0;

			// VW 2023 SP4 -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
			virtual VCOMError VCOM_CALLTYPE IFC_AddObjectMapping(const TXString& objectName, const TXString& condition, EMappingCategory category) = 0;
			virtual VCOMError VCOM_CALLTYPE IFC_DeleteObjectMapping(const TXString& objectName) = 0;
			virtual VCOMError VCOM_CALLTYPE IFC_IsFieldVisible(const TXString& objectName, const TXString& mainEntry, const TXString& childEntry, const TXString& fieldName, bool& outVisible) = 0;
			virtual VCOMError VCOM_CALLTYPE IFC_SetFieldVisible(const TXString& objectName, const TXString& mainEntry, const TXString& childEntry, const TXString& fieldName, bool bVisible) = 0;
			virtual VCOMError VCOM_CALLTYPE IFC_GetDataSheetsCount(const TXString& objectName, short& outDSCount) = 0;
			virtual VCOMError VCOM_CALLTYPE IFC_GetDataSheetsNameAt(const TXString& objectName, short iDataSheet, TXString& outDataSheetName) = 0;
			virtual VCOMError VCOM_CALLTYPE IFC_CreateDataSheet(const TXString& objectName, const TXString& dataSheetName) = 0;
			virtual VCOMError VCOM_CALLTYPE IFC_DeleteDataSheet(const TXString& objectName, const TXString& dataSheetName) = 0;
			virtual VCOMError VCOM_CALLTYPE IFC_GetDataSheetFieldsCount(const TXString& objectName, const TXString& dataSheetName, short& outFieldsCount) = 0;
			virtual VCOMError VCOM_CALLTYPE IFC_GetDataSheetFieldInfoAt(const TXString& objectName, const TXString& dataSheetName, short iField, TXString& outFieldLabel, bool& outIsVisible, bool& outIsByFormula) = 0;
			virtual VCOMError VCOM_CALLTYPE IFC_AddDataSheetField(const TXString& objectName, const TXString& dataSheetName, const TXString& mainEntry, const TXString& childEntry, const TXString& fieldName, const TXString& fieldLabel) = 0;
			virtual VCOMError VCOM_CALLTYPE IFC_DeleteDataSheetField(const TXString& objectName, const TXString& dataSheetName, const TXString& fieldLabel) = 0;
			virtual VCOMError VCOM_CALLTYPE IFC_SetDSFieldVisible(const TXString& objectName, const TXString& dataSheetName, const TXString& fieldLabel, bool isVisible) = 0;
			virtual VCOMError VCOM_CALLTYPE IFC_AddRecordToObjectMapping(const TXString& objectName, const TXString& recordName, const TXString& condition, bool bEnable) = 0;
			virtual VCOMError VCOM_CALLTYPE IFC_DeleteRecordFromObjectMapping(const TXString& objectName, const TXString& recordName) = 0;
			virtual VCOMError VCOM_CALLTYPE IFC_IsRecordEnabled(const TXString& objectName, const TXString& recordName, bool& outIsEnabled) = 0;
			virtual VCOMError VCOM_CALLTYPE IFC_SetRecordEnabled(const TXString& objectName, const TXString& recordName, bool bEnable) = 0;

			// VW 2023 SP6 -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
			virtual VCOMError VCOM_CALLTYPE	IFC_DefPsetImportFile(IFileIdentifierPtr pFileID) = 0;

			// VW 2024 -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
			virtual VCOMError VCOM_CALLTYPE IFC_ReadProjectData(EExportIFCPane pane, Sint16 iParam, Sint16 iBuilding, TXString& outData) = 0;
			virtual VCOMError VCOM_CALLTYPE IFC_WriteProjectData(EExportIFCPane pane, Sint16 iParam, Sint16 iBuilding, const TXString& data) = 0;
			virtual VCOMError VCOM_CALLTYPE IFC_GetStructureGUID(EGUID type, Sint16 iBuilding, Sint16 iStorey, TXString& outGUID) = 0;
			virtual VCOMError VCOM_CALLTYPE IFC_SetStructureGUID(EGUID type, Sint16 iBuilding, Sint16 iStorey, const TXString& guid) = 0;

			// VW 2024 SP4 -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
			virtual void VCOM_CALLTYPE		IFC_GetIDSWorksheetFunctions(std::vector<TXString>& outArray) = 0;
		};
	}
}
