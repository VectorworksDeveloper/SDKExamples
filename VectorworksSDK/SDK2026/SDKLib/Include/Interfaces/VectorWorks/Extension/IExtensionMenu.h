...
namespace VectorWorks
{
	namespace Extension
	{
		...
		public:
			...
			virtual const TXString& VCOM_CALLTYPE	GetSearchSynonyms() = 0;
			virtual	void VCOM_CALLTYPE				GetNeedsFlags(EMenuEnableFlags& outNeeds, EMenuEnableFlags& outNeedsNot) = 0;
