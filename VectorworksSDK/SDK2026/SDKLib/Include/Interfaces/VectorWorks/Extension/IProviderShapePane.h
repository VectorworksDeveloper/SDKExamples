...
namespace VectorWorks
{
	namespace Extension
	{
		...
		public:
			...
			// Should match Switchboard.DataTypes.X.h
			enum EBoxPoint {
				kPointTopLeft=0,
				kPointTopMiddle=1,
				kPointTopRight=2,
		...
		public:
			...
			// kWidgetMultiSelectionSearchablePopup
			virtual void							UpdateTextFromActiveItems(SintptrT viewWidget) = 0;
			virtual std::vector<TXString>			GetActiveItems(SintptrT viewWidget) = 0;
			virtual void							SetActiveItems(SintptrT viewWidget, const std::vector<TXString>& activeItems) = 0;

			virtual EBoxPoint			GetBoxWidgetPosition(SintptrT viewWidget) = 0;
			virtual WorldPt				GetBoxWidgetLocation(const WorldRectVerts& verts, EBoxPoint alignment) = 0;
		};
		...
		public:
			...
			virtual void		VCOM_CALLTYPE		InitContent()																				{}
