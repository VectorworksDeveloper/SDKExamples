	...
	namespace Extension
	{
		...
		*/
		...
		public:
			...
			// --------------------------------------------------------------------------------------------------------
			virtual bool			VCOM_CALLTYPE	IsElevationBenchmarkConstrained(MCObjectHandle hObject)																			= 0;
			virtual void			VCOM_CALLTYPE	RemoveElevationBenchmarkConstraining(MCObjectHandle hObject)																		= 0;
		};
