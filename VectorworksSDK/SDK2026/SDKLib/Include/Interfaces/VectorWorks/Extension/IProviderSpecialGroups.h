...
namespace VectorWorks
{
	namespace Extension
	{
		...
		public:
			...
			//VW2024
			// Set this to true if you want tool insertion in the special group to support automatic plane and not just screen plane.
			virtual bool VCOM_CALLTYPE			AllowAutomaticPlaneInsertion() { return false; }

			// Set this to true if you want to see the Edit Profile context menu in homogenous multiple selection
			virtual bool VCOM_CALLTYPE			AllowEditProfileInMultiSelect() { return false; }

			// VW2026
			// Select the subpart object from the worksheet. Return true if the subpart object is selected.
			virtual bool VCOM_CALLTYPE			SelectSubpartObjFromWorksheet(MCObjectHandle hMainObj, MCObjectHandle hSubpartObj) { return false; }
		};
	}
}
