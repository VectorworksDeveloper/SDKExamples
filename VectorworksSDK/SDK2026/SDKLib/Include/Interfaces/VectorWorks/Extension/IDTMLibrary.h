...
namespace VectorWorks
{
	namespace Extension
	{
		...
		struct SRelativePositionPoly
		{
			VectorWorks::Math::IPolyDef*	fPoly;
			ERelativePosition				fRelativePosition;
		};
		...
		public:
			...
			// vw2023
			virtual void	VCOM_CALLTYPE	RecalculateSiteModel(MCObjectHandle hObject, bool recreateFromSourceData ) = 0;
			virtual void	VCOM_CALLTYPE	TransformPoints(MCObjectHandle hObject, std::function<void(std::vector<WorldPt>& points)> transformCallback ) = 0;

			// vw2024
			virtual bool	VCOM_CALLTYPE	InterpolatePtElevationTo3DPolygons(const std::vector<SRelativePositionPoly>& arr3DPolygons, double x, double y, double& ioElevation) = 0;
		};
