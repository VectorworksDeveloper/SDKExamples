...
namespace VectorWorks
{
	namespace Extension
	{
		...
		public:
			...
			virtual bool			VCOM_CALLTYPE GetDataTagExtractedData(MCObjectHandle hDataTag, TXStringSTLPairArray& outArrExtractedData, const TXString& txtLabel = "") = 0;
			...
			virtual bool			VCOM_CALLTYPE SetDataTagStyle(MCObjectHandle hDataTag, RefNumber style, bool skipValidation = false) = 0;
			...
			// Set to true to allow dynamic objects that are vertically aligned but overlapping to still form a chain
			// Otherwise overlapping objects do not auto constrain and will not form a chain
			virtual void			VCOM_CALLTYPE EnableOverlappingVerticalChains(MCObjectHandle hDataTag, bool enabled) = 0;

			// Subpart Utilities
			virtual bool			VCOM_CALLTYPE IsObjectTaggedAsSubpart(MCObjectHandle hSubpart) = 0;

			virtual void			VCOM_CALLTYPE SetIsDuplicatingObjects(bool isDuplicatingObjects) = 0;

			virtual bool			VCOM_CALLTYPE ShowEditTagDataDialog(MCObjectHandle hDataTag) = 0;
		};
		...
		public:
			...
			virtual void		VCOM_CALLTYPE SetFormula(MCObjectHandle hTextObj, const TXString& formula, bool isWorksheetFormula = false) = 0;
			...
			virtual bool		VCOM_CALLTYPE GetIsWorksheetFormula(MCObjectHandle hTextObj) = 0;

			virtual bool		VCOM_CALLTYPE GetUseCriteria(MCObjectHandle hTextObj) const = 0;
			virtual void		VCOM_CALLTYPE SetUseCriteria(MCObjectHandle hTextObj, bool value) = 0;
			virtual TXString	VCOM_CALLTYPE GetCriteria(MCObjectHandle hTextObj) const = 0;
			virtual void		VCOM_CALLTYPE SetCriteria(MCObjectHandle hTextObj, const TXString& criteria) = 0;
			virtual bool		VCOM_CALLTYPE GetSummarizeResult(MCObjectHandle hTextObj) const = 0;
			virtual void		VCOM_CALLTYPE SetSummarizeResult(MCObjectHandle hTextObj, bool value) = 0;
			virtual bool		VCOM_CALLTYPE GetUseParentObject(MCObjectHandle hTextObj) const = 0;
			virtual void		VCOM_CALLTYPE SetUseParentObject(MCObjectHandle hTextObj, bool value) = 0;
		};
