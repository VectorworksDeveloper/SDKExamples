...
namespace VectorWorks
{
	namespace Math
	{
		...
		public:
			...
			virtual bool				VCOM_CALLTYPE JoinPolylines(MCObjectHandle poly, MCObjectHandle toPoly, const WorldPt& polyEndPt = WorldPt(), const WorldPt& toPolyEndPt = WorldPt()) = 0;
			...
			virtual bool				VCOM_CALLTYPE JoinSinglePolyline(MCObjectHandle poly, MCObjectHandle toPoly, const WorldPt& polyEndPt, const WorldPt& toPolyEndPt) = 0;
		};
