...
namespace VectorWorks
{
	...
	enum EAdornerType
	{
		...
		kAdornerType_SolidLineWtOp,							// kLineNode, observes object line weight and opacity
	...
	public:
		...
		{
			bool	fDoWires = true;			// Draw wires
			bool	fDoSolid = true;			// Draw solid
			bool	fAutoRotate = false;		// Auto-rotate the object
			double	fAutoScaleSizePixels = 0.0;	// Auto-scale size in pixels
			bool	fInForeground = false;		// Draw in foreground
			bool	fCheckered = false;			// Checkered drawing
		};
		...
		virtual void			VCOM_CALLTYPE SetObjectOptions( short objType, Sint32 id, bool doWires, bool doSolid, bool autoRotate = false, double autoScaleSizePixels = 0.0, bool inForeground = false ) = 0;
		virtual void			VCOM_CALLTYPE SetObjectOptions( short objType, Sint32 id, const InteractiveOptions& options ) = 0;
