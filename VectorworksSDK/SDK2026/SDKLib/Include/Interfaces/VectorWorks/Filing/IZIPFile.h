...
namespace VectorWorks
{
	namespace Filing
	{
		...
		// ----------------------------------------------------------------------------------------------------
		// {1C2072B1-FCD3-4DC5-93AF-C84A993C9AD0}
		static const VWIID IID_Compressor = { 0x1c2072b1, 0xfcd3, 0x4dc5, { 0x93, 0xaf, 0xc8, 0x4a, 0x99, 0x3c, 0x9a, 0xd0 } };

		class DYNAMIC_ATTRIBUTE ICompressor : public IVWSingletonUnknown
		{
		public:
			virtual bool VCOM_CALLTYPE Deflate(const std::vector<std::uint8_t>& inUnCompressed, std::vector<std::uint8_t>& outCompressed) = 0;
			virtual bool VCOM_CALLTYPE Inflate(const std::vector<std::uint8_t>& inCompressed, std::vector<std::uint8_t>& outDeCompressed ) = 0;
		};
		typedef VCOMPtr<ICompressor>	ICompressorPtr;
	}
}
