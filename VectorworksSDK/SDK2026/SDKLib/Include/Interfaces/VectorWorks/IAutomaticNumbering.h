...
namespace VectorWorks
{
	...
	class DYNAMIC_ATTRIBUTE IAutomaticNumbering : public IVWUnknown
	{
		public:
			...
			virtual bool				VCOM_CALLTYPE RenumberAll(SAutoNumberingData& inOutNumberingData, EPatternMode patternMode = EPatternMode::NoPattern) = 0;
			...
			virtual bool				VCOM_CALLTYPE IsNumber(const TXString& inStr) const = 0;
			virtual bool				VCOM_CALLTYPE IsLetter(const TXString& inStr) const = 0;
			virtual bool				VCOM_CALLTYPE IsUpperLetter(const TXString& inStr) const = 0;
	};
