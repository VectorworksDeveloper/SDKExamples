...
namespace VectorWorks
{
	...
	namespace Imaging
	{
		...
		public:
			...
			{
				Uint32	fRawImageWidth	= 0;
				Uint32	fRawImageHeight	= 0;
				Uint32	fNumPasses		= 2;
			};
			...
			virtual VCOMError VCOM_CALLTYPE SetBlurAndSharpness(const GaussianBlurParams& blurParams, double amount = 0.5) = 0;
