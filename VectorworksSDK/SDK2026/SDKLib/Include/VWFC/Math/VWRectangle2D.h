...
namespace VWFC
{
	namespace Math
	{
		...
		public:
			...
			explicit	VWRectangle2D(const WorldRect& worldRect);
			...
			VWLine2D	GetLeftEdgeCW() const;
			VWLine2D	GetRightEdgeCW() const;
			VWLine2D	GetTopEdgeCW() const;
			VWLine2D	GetBottomEdgeCW() const;

			VWLine2D	GetLeftEdgeCCW() const;
			VWLine2D	GetRightEdgeCCW() const;
			VWLine2D	GetTopEdgeCCW() const;
			VWLine2D	GetBottomEdgeCCW() const;
			...
			bool		HasCommonAreaWith(const VWRectangle2D& rc) const;
			bool		HasCommonAreaWith(const VWRectangle2D& rc, double epsilon) const;
