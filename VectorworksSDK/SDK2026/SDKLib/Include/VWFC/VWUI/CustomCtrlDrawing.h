...
namespace VWFC
{
	namespace VWUI
	{
		...
		public:
			...
			void 				DrawDashedLine(const ViewPt& fromPt, const ViewPt& toPt, InternalIndex lineStyle);
...
//			void				PathBezierTo(Sint16 toX, Sint16 toY, Sint16 ctrl1X, Sint16 ctrl1Y, Sint16 ctrl2X, Sint16 ctrl2Y);
		...
		protected:
			...
			SintptrT			GetDevHandle() const { return fDevHandle; };
			void				SetDevHandle(SintptrT DevHandle) { fDevHandle = DevHandle; };
		private:
			void				PrepForFrame();
