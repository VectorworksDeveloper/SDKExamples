...
namespace VWFC
{
	namespace VWUI
	{
		...
		{
		public:
								VWCustomCtrlPen() : VWCustomCtrlPen(EUiControlTextTint::eGenericBlackTint) {};
								VWCustomCtrlPen(EUiControlTextTint tint);
								VWCustomCtrlPen(TGSColorV2 color);
...
//								VWCustomCtrlPen(ECustomCtrlPenStyle style, Uint8 red, Uint8 green, Uint8 blue, Uint16 size);
		...
		public:
			...
			void				SetColor(EUiControlTextTint tint);
			void				SetColor(GSColor color);
			void				SetColor(Uint8 red, Uint8 green, Uint8 blue);
			void				SetColor(TGSColorV2 color);
...
//			ECustomCtrlPenStyle	fStyle;
		...
		{
		public:
								VWCustomCtrlBrush() : VWCustomCtrlBrush(EUiControlTextTint::eGenericWhiteTint) {};
								VWCustomCtrlBrush(EUiControlTextTint tint);
								VWCustomCtrlBrush(TGSColorV2 color);
