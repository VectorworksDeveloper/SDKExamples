...
namespace VWFC
{
	namespace VWUI
	{
		...
		public:
			...
			// Inserts text in a text box at the text cursor location. 
			// If a part of the text is selected, it will get replaced with
			// the given text.
			void			InsertText(const TXString& text, bool replaceSelectedText );
		};
	}
}