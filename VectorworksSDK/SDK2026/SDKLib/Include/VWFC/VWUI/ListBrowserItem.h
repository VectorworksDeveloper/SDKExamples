...
namespace VWFC
{
	namespace VWUI
	{
		...
		public:
			...
			void						SetItemIndentLevel(short level);
			short						GetItemIndentLevel();
			
			void						SetItemIndeterminate(bool indeterminate);
			bool						GetItemIndeterminate();
		...
		public:
			...
			[[deprecated("Use ShowItemByClassOption instead")]] void ShowItemMarkerByClass(bool bShowByClass);
			void						ShowItemMarkerEditList(bool bShowEditList);
			[[deprecated("Use SetItemByClass instead")]] void SetItemMarkerByClass(bool bByClass);
			[[deprecated("Use GetItemByClass instead")]] bool GetItemMarkerByClass(bool& bByClass) const;
			...
			void						SetItemResourceContent(VectorWorks::Extension::IResourceManagerContent* content);
			...
			void						ShowItemByClassOption(bool bShowByClass);
			void						GetIsShowingItemByClassOption(bool bShowByClass);
			void						SetItemByClass(bool bByClass);
			bool						GetItemByClass(bool& bByClass) const;
