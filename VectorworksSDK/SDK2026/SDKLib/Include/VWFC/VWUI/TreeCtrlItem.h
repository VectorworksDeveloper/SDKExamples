...
namespace VWFC
{
	namespace VWUI
	{
		...
		public:
			static const VWTreeCtrlItem	kEmptyTreeItem;
		...
		public:
			...
			void					SetItemCheck(ECheckButtonCtrlState state, bool clickable = true);

			void					ExpandItem(bool bExpand);

			void					EnableMultiSelection(bool enabled = true);
