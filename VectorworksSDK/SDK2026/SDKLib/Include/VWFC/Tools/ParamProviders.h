...
namespace VWFC
{
	...
	namespace Tools
	{
		...
		public:
			...
			virtual bool			GetParamChoices(const TXString& univParamName, TXStringSTLArray& outArray) const = 0;
			virtual bool			GetParamLocalizedChoices(const TXString& univParamName, TXStringSTLArray& outArray) = 0;
			...
			virtual TNumStyleClass	GetParamNumStyle(const TXString& szParamName) const = 0;
			...
			virtual TXString		PopupGetLocalizedChoice(const TXString& univParamName, const TXString& key) = 0;
		...
		public:
			...
			void					ProcessParameterClass( bool bRead, InternalIndex& inOutValue, const InternalIndex& oldValue, const TXString& szParamName );
			void					ProcessParameterBuildingMaterial( bool bRead, MaterialRefNumber& inOutValue, MaterialRefNumber oldValue, const TXString& szParamName );
			void					ProcessParameterPenStyle( bool bRead, VWPattern& inOutValue, const VWPattern& oldValue, const TXString& szParamName );
			void					ProcessParameterPenWeight( bool bRead, Uint8& inOutValue, const Uint8& oldValue, const TXString& szParamName );
			void					ProcessParameterColor( bool bRead, ColorRef& inOutValue, const ColorRef& oldValue, const TXString& szParamName );
			void					ProcessParameterTexture( bool bRead, InternalIndex& inOutValue, const InternalIndex& oldValue, const TXString& szParamName );
			void					ProcessParameterSymDef( bool bRead, InternalIndex& inOutValue, const InternalIndex& oldValue, const TXString& szParamName );
			void					ProcessParameterFill( bool bRead, VWPattern& inOutValue, const VWPattern& oldValue, const TXString& szParamName );
		...
		public:
			...
			virtual bool			GetParamLocalizedChoices(size_t paramIndex, TXStringSTLArray& outArray) = 0;
			virtual EFieldStyle		GetParamStyle(size_t paramIndex) const = 0;
			virtual TNumStyleClass	GetParamNumStyle(size_t paramIndex) const = 0;
		...
		public:
			...
			virtual bool			GetParamChoices(const TXString& univParamName, TXStringSTLArray& outArray) const;
			virtual bool			GetParamLocalizedChoices(const TXString& univParamName, TXStringSTLArray& outArray);
			...
			virtual TNumStyleClass	GetParamNumStyle(const TXString& szParamName) const;
			...
			virtual TXString		PopupGetLocalizedChoice(const TXString& univParamName, const TXString& key);
		...
		public:
			...
			virtual bool			GetParamLocalizedChoices(size_t paramIndex, TXStringSTLArray& outArray);
			virtual EFieldStyle		GetParamStyle(size_t paramIndex) const;
			virtual TNumStyleClass	GetParamNumStyle(size_t paramIndex) const;
		...
		private:
			std::shared_ptr<CParamProviderAbstract>	fProvider;
		};
