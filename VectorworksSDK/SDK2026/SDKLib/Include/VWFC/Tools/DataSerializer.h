...
namespace VWFC
{
	namespace Tools
	{
		...
		public:
			...
			bool							IsGroupIdentifier(TDataIdentifier id, const char* dummy=nullptr);
		...
		public:
			...
			// Copy constructor
			VWDataSerializer(const VWDataSerializer& other) = delete;
			// Copy assignment
			VWDataSerializer& operator=(const VWDataSerializer& other) = delete;
			// Move constructor
			VWDataSerializer(VWDataSerializer&& other) noexcept = delete;
			// Move assignment
			VWDataSerializer& operator=(VWDataSerializer&& other) noexcept = delete;
		...
		public:
			...
			void						UntrackedSaveDataInMemory(void* pData) const;

			// save in raw memory of an object handle
			void						SaveDataInObjectHandle(MCObjectHandle userDataNodeHandle, const TXString& changeName = NULLSTR, bool bTrackChange = true) const;
			void						SaveDataInObjectHandle(MCObjectHandle userDataNodeHandle, const std::vector<TXString>& changeNames, bool bTrackChange = true) const;
			void						SaveDataInObjectHandle(MCObjectHandle userDataNodeHandle, IWriteContext* writeContext, const TXString& changeName = NULLSTR, bool bTrackChange = true) const;
