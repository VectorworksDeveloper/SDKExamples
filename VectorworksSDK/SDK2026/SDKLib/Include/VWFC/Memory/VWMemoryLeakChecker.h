...
#define MML_BLOCK_COUNT (100000)
		...
		private:
			...
			std::vector<const void*> m_pbeforeBlocks;
			std::vector<const void*> m_pafterBlocks;
			std::vector<const void*> m_pdiffBlocks;
...
namespace SystemTests
{
	...
	{
		CPPUNIT_TEST_SUITE2(MemoryLeakTest, "Memory Leak Checker", "jsimerly@vectorworks.net", ESystemTestType::SpecialRun);
