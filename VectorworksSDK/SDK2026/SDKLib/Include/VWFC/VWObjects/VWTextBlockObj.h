...
namespace VWFC
{
	...
	namespace VWObjects
	{
		...
		public:
			...
			bool			SetTightFill(bool tightFill) const;

			// SIA elevation text
			bool			IsSIAElevationText() const;

			// SIA formatting
			bool			FormatAsSIA(const TXString& centimeters, const TXString& millimeters, double superscriptScalePercent = 100);
			bool			FormatAsSIA(WorldCoord value, bool alwaysMeters, double superscriptScalePercent = 100);
			bool			FormatSegmentAsSIA(size_t startIndex, size_t countChars, double superscriptScalePercent = 100);
		...
		public:
			...
			static bool		IsTextBlockObject(MCObjectConstHandle hObj);
