...
namespace VWFC
{
    namespace VWObjects
    {
      ...
      enum class EEmbodiedCarbonUnitType : char {
            CO2ePerWeight = 0,
            CO2ePerLength = 1,
            CO2ePerArea = 2,
            CO2ePerVolume = 3,
        ...
        public:
            ...
            VWFC::VWObjects::EEmbodiedCarbonUnitType GetOvEmbodiedCarbonUnitType();
            void SetOvEmbodiedCarbonUnitType(VWFC::VWObjects::EEmbodiedCarbonUnitType embodiedCarbon);

			bool GetOvEmbodiedCarbonManufFlag();
			void SetOvEmbodiedCarbonManufFlag(bool embodiedCarbonManufFlag);
