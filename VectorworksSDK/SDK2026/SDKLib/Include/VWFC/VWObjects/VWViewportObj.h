...
namespace VWFC
{
	...
	namespace VWObjects
	{
		...
		public:
			...
			bool				SetDataVizSchemes(const UuidStorageList& inSchemes);
			bool				GetDataVizSchemes(UuidStorageList& outSchemes) const;
			
			TXString			GetActivePhaseName() const;
			
		public:
			static bool			IsViewportObject(MCObjectConstHandle hObj);
