...
namespace VWFC
{
	namespace VWObjects
	{
		...
		enum ESymbolInsertMode {
			...
			kSymbolInsertMode_WallInsertLocation		= kSymInsertOnWallInsertLocation,
			kSymbolInsertMode_WallClosureInsertLocation	= kSymInsertOnWallClosureInsertLocation
		};
		...
		public:
			...
			bool					GetPageBased() const;
			void					SetPageBased(bool bPageBased);
...
*/
		...
		public:
			...
			static bool				IsSymbolDefObject(MCObjectConstHandle hObj);
