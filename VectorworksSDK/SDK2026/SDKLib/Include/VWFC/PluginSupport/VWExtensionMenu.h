...
namespace VWFC
{
	namespace PluginSupport
	{
		...
		public:
			...
			class ICheckedStatusContext
			{
			public:
				virtual			~ICheckedStatusContext()		{}
				virtual void	Clear() = 0;
				virtual void	SetChecked(bool value) = 0;
				virtual void	SetChecked(Sint16 chunkIndex, bool value) = 0;
			};

			virtual void		GetItemsCheckedStatus(ICheckedStatusContext* context);
		...
		protected:
			...
			class CCheckedStatusContext : public ICheckedStatusContext
			{
			public:
								CCheckedStatusContext(MenuCheckHiliteMessage* msg);
				virtual void	Clear();
				virtual void	SetChecked(bool value);
				virtual void	SetChecked(Sint16 chunkIndex, bool value);

			private:
				MenuCheckHiliteMessage*	fMessage;
			};
		};
		...
		struct SMenuDef
		{
			EMenuEnableFlags	fNeeds;
			EMenuEnableFlags	fNeedsNot;
			SResString			fTitle;
			SResString			fCategory;
			SResString			fHelpText;
			Sint16				fVersionCreated;
			Sint16				fVersionModified;
			Sint16				fVersionRetired;
		...
		public:
			...
			virtual	void VCOM_CALLTYPE				GetNeedsFlags(EMenuEnableFlags& outNeeds, EMenuEnableFlags& outNeedsNot);
		...
		protected:
			...
			void						SetSearchSynonyms(const TXString& synonyms);
