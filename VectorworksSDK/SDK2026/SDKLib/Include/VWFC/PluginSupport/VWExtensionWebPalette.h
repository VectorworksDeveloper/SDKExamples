...
// Variant of END_WebPalette_DISPATCH_MAP without error message if the function is not found
// Use this when you distribute the function handlers between various classes
#define		END_WebPalette_DISPATCH_MAP2						else { } }
