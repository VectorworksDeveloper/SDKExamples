...
namespace VWFC
{
	namespace PluginSupport
	{
		...
		public:
			virtual Sint32 VCOM_CALLTYPE		Execute(Sint32 action, PluginLibraryArgTable* argumentTable) override;
		...
		// IExtensionApp
		public:
			virtual IEventSink* VCOM_CALLTYPE			QueryEventSink(const TSinkIID& iid) override;

		// IExtensionVSFunctions
		public:
			virtual Uint32 VCOM_CALLTYPE				Initialize() override;
			virtual size_t VCOM_CALLTYPE				GetFunctionsCount() override;
			virtual const TXString& VCOM_CALLTYPE		GetFunctionName(size_t funcIndex) override;
			virtual const TXString& VCOM_CALLTYPE		GetFunctionCategory(size_t funcIndex) override;
			virtual const TXString& VCOM_CALLTYPE		GetFunctionDescription(size_t funcIndex) override;
			virtual Sint32 VCOM_CALLTYPE				GetFunctionVersion(size_t funcIndex) override;
			virtual Sint8 VCOM_CALLTYPE					GetFunctionScope(size_t funcIndex) override;
			virtual bool VCOM_CALLTYPE					GetFunctionHasReturnValue(size_t funcIndex) override;
			virtual size_t VCOM_CALLTYPE				GetFunctionParamsCount(size_t funcIndex) override;
			virtual const TXString& VCOM_CALLTYPE		GetFunctionParamName(size_t funcIndex, size_t paramIndex) override;
			virtual EPluginLibraryArgType VCOM_CALLTYPE	GetFunctionParamType(size_t funcIndex, size_t paramIndex) override;
...
#define DEFINE_VWVSFunctions	DEFINE_VWVSFunctionsExtension;	\
								virtual void		InitRoutines() override;
