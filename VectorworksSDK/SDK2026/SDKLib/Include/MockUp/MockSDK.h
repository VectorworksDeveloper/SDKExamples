...
namespace MockUp
{
	...
	public:
		...
		virtual Boolean VCOM_CALLTYPE IsVisible(MCObjectHandle h, EVisibilityType visType = EVisibilityType::eActiveClassesLayers) override
		{
			return false;
		}
		...
		virtual MCObjectHandle VCOM_CALLTYPE CreateCustomObjectPath(const TXString& name, MCObjectHandle pathHand, MCObjectHandle profileGroupHand, bool doRegen) override
		{
				return NULL;
		}
		...
		virtual Boolean VCOM_CALLTYPE AdjustComponentPixelPos(Sint32 nDialogID, Sint32 nComponentID, int nHorizontalPixels, int nVerticalPixels, bool bKeepBinding /*= false*/) override
		{
			return false;
		}
		...
		virtual Boolean VCOM_CALLTYPE GetTreeControlSelectedItems(Sint32 nDialogID, Sint32 nComponentID, std::vector<Sint32>& nItemsIDs) override
		{
			return false;
		}
		...
		virtual short VCOM_CALLTYPE GetPerspectiveType(MCObjectHandle theLayer) override
		{
			return 0;
		}
		...
		virtual void VCOM_CALLTYPE GetCurrentWorkspaceFileName(TXString& outFileName) override
		{
	
		}
		virtual void VCOM_CALLTYPE SetWorkspaceFileToReload(const TXString& inFileNameOrPath) override
		{
	...
	public:
		...
		virtual bool VCOM_CALLTYPE ExportResource(MCObjectHandle resource, IFileIdentifier* pFileID , bool suppressDialogs, bool preserveFolders) override
		{
			return false;
		}
	...
	public:
		...
		virtual bool VCOM_CALLTYPE ExportResourceN(MCObjectHandle resource, IFileIdentifier* pFileID, TImportResourceConflictCallbackProcPtr conflictCallback, bool preserveFolders) override
		{
			return false;
		}
	...
	public:
		...
		virtual void SetPerspectiveInfo(short projKind, short renderMode, WorldCoord persDistance, const WorldPt &pt1, const WorldPt &pt2, short perspType = perspectiveStandard) override
		{
		}
		...
		virtual bool SetTreeControlItemCheckBoxState(Sint32 nDialogID, Sint32 nComponentID, int nItemID, Sint32 state, bool clickable = true) override
		{
			return false;
		}
		...
		virtual bool ExportSymbolResource(MCObjectHandle symbolresource, const TXString& symbolFolderDestName, IFileIdentifier* pFileID, bool suppressDialogs, TImportResourceConflictCallbackProcPtr conflictCallback, bool preserveFolders) override
		{
			return false;
		}
	...
	public:
		...
		virtual MCObjectHandle VCOM_CALLTYPE CreateImgFromSymbol( const TXString & symbolName, SymbolImgInfo& imgInfoInOut, bool supportDarkMode = false) override
		{											   
			return NULL;							   
		}											   
	...
	public:
		...
		virtual bool ExportResourceList(const TVWArray_MCObjectHandle& inResourceList, IFileIdentifier* pFileID, bool suppressDialogs, bool preserveFolders = false) override
		{
			return false;
		}

		virtual bool ExportResourceListN(const TVWArray_MCObjectHandle& inResourceList, IFileIdentifier* pFileID, TImportResourceConflictCallbackProcPtr conflictCallback, bool preserveFolders) override
		{
			return false;
		}
	...
	public:
		...
		virtual Handle			VCOM_CALLTYPE CompileCriteriaExpression(const TXString& criteria, std::function<void(ECriteriaExpressionError err, size_t errOffset)> onErrorCallback, EExpressionContext context, std::vector<TXString>* outUsedRecordNames=nullptr) override { return nullptr; }
	...
	public:
		...
		virtual bool			VCOM_CALLTYPE FormatTextObjectInSIA(MCObjectHandle hText, const TXString& centimeters, const TXString& millimeters, double superscriptScalePercent = 100) override { return false; }
		virtual bool			VCOM_CALLTYPE FormatTextObjectSegmentInSIA(MCObjectHandle hText, size_t startIndex, size_t countChars, double superscriptScalePercent = 100) override { return false; }
	...
	public:
		...
		virtual void			VCOM_CALLTYPE GetScreenFullSize(ViewRect& out) override {  }
		...
		virtual bool			VCOM_CALLTYPE CoordToSIAStringN(WorldCoord value, VectorWorks::Units::IVWUnits* dimUnit, bool alwaysMeters, TXString& outCentimeters, TXString& outMillimeters) override { return false; }
		virtual void			VCOM_CALLTYPE DoubleToStringN(TNumStyleClass inNumStyle,  Byte inAccuracy, Byte inFormat, double_param inDouble, TXString& outString) override {}
		virtual void			VCOM_CALLTYPE DoubleToStringInUnitsN(TNumStyleClass inNumStyle, Byte inAccuracy, Byte inFormat, double_param inDouble, VectorWorks::Units::IVWUnits* dimUnit, TXString& outString) override {}

		virtual	Boolean 		VCOM_CALLTYPE CreateDataVisualizationPullDownMenu(Sint32 nDialogID, Sint32 nComponentID, int widthInStdChar, bool bShowDefaultStaticItems /*= true*/) override { return false; };
        
        virtual void            VCOM_CALLTYPE CreateSortedContourCurves(MCObjectHandle h, const WorldPt3& pointOnPlane, const WorldPt3& planeNormal, TMCObjectHandlesSTLArray& outBoundariesArray, TMCObjectHandlesSTLArray& outHolesArray) override {}


		virtual MCObjectHandle	VCOM_CALLTYPE CreateSectionViewport(const WorldPt& sectionLinePt1, const WorldPt& sectionLinePt2, const WorldPt& sectionLinePt3, double depth, double startHeight, double endHeight, MCObjectHandle hVPLayer) override { return nullptr; }

		virtual bool			VCOM_CALLTYPE GetAppParameter(size_t paramIndex, TXString& outValue) override { return false; }

		virtual bool			VCOM_CALLTYPE EnableListBrowserDragOnIndices(Sint32 liDialogID, Sint32 liComponentID, const std::vector<bool>& arrIndicesDragEnableState) override { return false; }

		virtual MCObjectHandle	VCOM_CALLTYPE CreateSingleOffsetPoly(MCObjectHandle hPoly, double offset) override { return nullptr; }

		virtual GSColor			VCOM_CALLTYPE GetControlTextColorByTint(EUiControlTextTint tint) override { return GSColor(); }
	...
	// VW2024 Update 2
	public:
		virtual Boolean	VCOM_CALLTYPE AddUndoRedoSelectObj(MCObjectHandle h, EUndoSelectionState undoSelection, ERedoSelectionState redoSelection, bool clearSelectionsBeforeUndo = false, bool clearSelectionsBeforeRedo = false) override { return false; }

		virtual void	VCOM_CALLTYPE GetDocumentDataVisualizations(std::vector<TXString>& outData) override {};
		virtual bool	VCOM_CALLTYPE RenameDataVisualization(const TXString& oldName, const TXString& newName) override { return false; };
		virtual bool	VCOM_CALLTYPE DeleteDataVisualization(std::vector<TXString>& dataVisToDelete) override { return false; };

		virtual void VCOM_CALLTYPE RotateObjectPlanar(MCObjectHandle h, const WorldPt& rotCenter, double_param angle) override {}

		virtual TXString VCOM_CALLTYPE GetWallClosureName(MCObjectHandle hObject) override { return TXString(); }
		virtual bool VCOM_CALLTYPE SetWallClosureName(MCObjectHandle hObject, const TXString &wallClosureName) override { return false; }
		virtual bool VCOM_CALLTYPE GetWallClosureNameByStyle(MCObjectHandle hObject) override { return false; }
		virtual bool VCOM_CALLTYPE SetWallClosureNameByStyle(MCObjectHandle hObject, bool byStyle) override { return false; }
		virtual void VCOM_CALLTYPE GetExistingWallClosureNames(MCObjectHandle hObject, TXStringArray &existingWallClosureNames) override { return; }
		virtual bool VCOM_CALLTYPE GetObjectWallClosureInfoForName(MCObjectHandle objectHandle, MCObjectHandle wallHandle, const TXString &wallClosureName, WallClosureInfo &wallClosureInfo) override { return false; }

	// VW2024 Update 3
	public:
		// calls Criteria Dialog with specific context
		virtual bool	VCOM_CALLTYPE ShowCriteriaDialogContext(TXString& inOutCriteria, bool showObjectsCount, ECriteriaContext context) override { return false; }
		virtual bool	VCOM_CALLTYPE IsDocumentReady() override { return false; }

	// VW2024 Update 4
	public:
		virtual bool	VCOM_CALLTYPE IsNurbsCornerPoint(MCObjectHandle hNurbs, Sint16 pointIndex) override { return false; }
		virtual Boolean	VCOM_CALLTYPE GetListBrowserItemIndeterminate(Sint32 dialogID, Sint32 componentID, Sint32 itemIndex, Sint32 iSubItemIndex, bool& indeterminate) override { return false; }
		virtual Boolean	VCOM_CALLTYPE SetListBrowserItemIndeterminate(Sint32 dialogID, Sint32 componentID, Sint32 itemIndex, Sint32 iSubItemIndex, bool indeterminate) override { return false; }

		virtual Axis VCOM_CALLTYPE SetWPHybridToolN(bool bDoingPauseAndRestore) override
		{
			Axis axis;
			axis.i.Set(1, 0, 0);
			axis.j.Set(0, 1, 0);
			axis.k.Set(0, 0, 1);
			axis.vertex.Set(0, 0, 0);
			return axis;
		}

		virtual MCObjectHandle VCOM_CALLTYPE CreateFormattedUnlinkedTextCopy(MCObjectHandle originalText) override { return nullptr; }
	
	// VW2025
	public:
		virtual Boolean	        VCOM_CALLTYPE IsVisibleByLayerAndClass(MCObjectHandle hObject, bool requireModifiable = false, bool allowGrayed = false) override { return false; }
		virtual bool	        VCOM_CALLTYPE RemoveClassItems(Sint32 nDialogID, Sint32 nComponentID, const std::vector<TXString>& arrClassNames) override { return false; };
		
		virtual bool 	        VCOM_CALLTYPE RunPopover(Sint32 dialogID, GS_EventHandlerProcPtr handleEvent, void* env, const TXString& contextualHelpID, const CPopoverParameters&) override { return false; };
        
        virtual MCObjectHandle  VCOM_CALLTYPE ComputePolyWithPerEdgeOffsets(MCObjectHandle polyH, const std::vector<double>& offsets, std::map<size_t, size_t> & vertexMapping, bool bInsertNewOffset = false) override {return nullptr;}

		virtual void VCOM_CALLTYPE UnhideObjects() override { return; };
		virtual void VCOM_CALLTYPE ShowSelectedObjectsOnly() override { return; };
		virtual void VCOM_CALLTYPE HideSelectedObjects() override { return; };
		virtual void VCOM_CALLTYPE SetObjectsVisibility(const std::vector<MCObjectHandle>& objectHandles, bool visible) override { return; };

		virtual void	VCOM_CALLTYPE CloseAllFilesAndQuitVectorworks(bool bAskForSave = true, bool bRestart = false) override {}
		virtual Extension::IWebPaletteFrame*	VCOM_CALLTYPE GetWebPaletteFrame(const VWIID& extensionIID) override {return nullptr;}
		
		virtual Boolean VCOM_CALLTYPE GetTreeControlItemStyle(Sint32 dialogID, Sint32 componentID, Sint32 itemID, STreeControlItemStyle& itemStyle) override { return false; };
		virtual Boolean VCOM_CALLTYPE SetTreeControlItemStyle(Sint32 dialogID, Sint32 componentID, Sint32 itemID, const STreeControlItemStyle& itemStyle) override { return false; };
		virtual Boolean VCOM_CALLTYPE IsTreeControlItemExpanded(Sint32 dialogID, Sint32 componentID, Sint32 itemID) const override { return false; };
		
		virtual void VCOM_CALLTYPE GetCurrentWorkspaceFilePath(TXString& outFilePath) override { return; };
		virtual bool	VCOM_CALLTYPE ShowCriteriaDialogContextCustomCount(TXString& inOutCriteria, bool showObjectsCount, ECriteriaContext context, const TCriteriaCustomCountCallback& customCountCallback = nullptr) override { return false; };
		
		virtual void VCOM_CALLTYPE InitHandingWidgets() override { return; };
		virtual void VCOM_CALLTYPE UpdateHandingWidgets(bool bSelectionChange) override { return; };
		virtual void VCOM_CALLTYPE ClearHandingWidgets() override { return; };

		virtual short VCOM_CALLTYPE CreateDimensionAngularUnitSetting(const TXString& settingName, EAngUnitIndex angUnitIndex, short angUnitMode, Boolean showLeading0, Boolean showTrailing0) override { return 0; }
		virtual short VCOM_CALLTYPE CreateDimensionLinearUnitSetting(const TXString& settingName, EUnitIndex primUnitIndex, EUnitIndex secUnitIndex = EUnitIndex::Millimeters) override { return 0; }
		virtual Boolean VCOM_CALLTYPE GetDimensionAngularUnitVariable(short customUnitIndex, short fieldSelector, TVariableBlock& value) override	{ return false;	}
		virtual Boolean VCOM_CALLTYPE GetDimensionLinearUnitVariable(short customUnitIndex, short fieldSelector, TVariableBlock& value) override { return false; }
		virtual Boolean VCOM_CALLTYPE SetDimensionAngularUnitVariable(short customUnitIndex, short fieldSelector, const TVariableBlock& value) override { return false; }
		virtual Boolean VCOM_CALLTYPE SetDimensionLinearUnitVariable(short customUnitIndex, short fieldSelector, const TVariableBlock& value) override { return false; }

		virtual MCObjectHandle VCOM_CALLTYPE IsAssemblyEditModeActive() override { return nullptr; };
		virtual MCObjectHandle VCOM_CALLTYPE IsObjectInsertedInAssembly(MCObjectHandle h) override { return nullptr; };

		virtual bool VCOM_CALLTYPE EnumerateVWResources(const char* resourceFolderIdentifier, bool recursive, std::function<void(const TXString& resourceIdentifier)> callback) override { return false; }
        
        virtual size_t VCOM_CALLTYPE PolylineCurveCountBetweenTwoCornerVertices(MCObjectHandle h, size_t index1, size_t index2) override { return 0; };

		virtual void VCOM_CALLTYPE SetActivePlaneToLayerPlane() override {};
		...
		virtual void VCOM_CALLTYPE TransferAuxList(MCObjectHandle hSource, MCObjectHandle hDestination, bool isForDuplication, bool transferUserDataNodes) override { }
		
	// VW2025 Update 3
	public:
		virtual bool			VCOM_CALLTYPE GetListBrowserItemByClass(Sint32 dialogID, Sint32 componentID, int iItemIndex, int iSubItemIndex, bool& bByClass) override { return false; };
		virtual bool			VCOM_CALLTYPE SetListBrowserItemByClass(Sint32 dialogID, Sint32 componentID, int iItemIndex, int iSubItemIndex, bool bByClass) override { return false; };
		virtual bool			VCOM_CALLTYPE GetShowListBrowserItemByClassOption(Sint32 dialogID, Sint32 componentID, int iItemIndex, int iSubItemIndex, bool& bShowByClass) override { return false; };
		virtual bool			VCOM_CALLTYPE ShowListBrowserItemByClassOption(Sint32 dialogID, Sint32 componentID, int iItemIndex, int iSubItemIndex, bool bShowByClass) override { return false; };
        
    // VW2025 Update 4
    public:
        virtual MCObjectHandle VCOM_CALLTYPE CreateNewSolidForWDAssemblyCuttingHole(MCObjectHandle wall, MCObjectHandle mainHole, MCObjectHandle insert, MCObjectHandle solid ,bool bInteriorSideIsRight, short sAssemblyAccessoryId,short sillType) override
        { return nullptr; };
        

	// VW2025 Update 5
	public:
		virtual bool VCOM_CALLTYPE InitInteractivePIOResizer() override { return false; };
		virtual bool VCOM_CALLTYPE IsInteractivePIOResizerActive() override { return false; };
		virtual bool VCOM_CALLTYPE MouseMoveInteractivePIOResizer() override { return false; };
		virtual bool VCOM_CALLTYPE CompleteInteractivePIOResizer() override { return false; };
		virtual void VCOM_CALLTYPE CancelInteractivePIOResizer() override {};
    // VW2025 Update 6
        virtual void VCOM_CALLTYPE FitDWAccesories2DDispalayToClosureGeometry(MCObjectHandle pio, TStandardView view, WorldCoord cutPlaneCoordinate) override {};
	// VW2026
    public:

        virtual void VCOM_CALLTYPE TrackSwapChange(MCObjectHandle handle, const TXString& changeName = NULLSTR) override { };
        virtual bool VCOM_CALLTYPE ShowCriteriaDialogExt(SCriteriaDialogParam& inOutData, bool showObjectsCount, ECriteriaContext context, const TCriteriaCustomCountCallback& customCountCallback = nullptr) override { return false; };
		...
		virtual bool VCOM_CALLTYPE SetGradientSliderFaderMode(Sint32 dialogID, Sint32 componentID, bool faderMode) override { return false; };
		virtual bool VCOM_CALLTYPE GetGradientSliderFaderMode(Sint32 dialogID, Sint32 componentID, bool& faderMode) override { return false; };
		virtual bool VCOM_CALLTYPE SetGradientSliderLiveUpdate(Sint32 dialogID, Sint32 componentID, bool liveUpdate) override { return false; };

		virtual bool VCOM_CALLTYPE AddObjectActionHighlight(MCObjectHandle hHighlightObject) override { return false; }
		virtual bool VCOM_CALLTYPE RemoveObjectActionHighlight(MCObjectHandle hHighlightObject) override { return false; }
		virtual void VCOM_CALLTYPE ClearActionHighlight() override {}
		...
		virtual Sint16 		VCOM_CALLTYPE GetNumPhases() override { return 0; };
		virtual SPhaseData 	VCOM_CALLTYPE GetPhase(Sint16 index) override { SPhaseData phaseData; return phaseData; }
		virtual void 		VCOM_CALLTYPE SetPhaseName(Sint16 index, const TXString& name) override { };
		virtual void 		VCOM_CALLTYPE SetPhaseDescription(Sint16 index, const TXString& description) override { };
		virtual SObjPhaseStatus	VCOM_CALLTYPE GetPhaseStatus(MCObjectHandle hObject) override { return SObjPhaseStatus{}; };
		virtual SPhaseData	VCOM_CALLTYPE GetDocumentActivePhase() override { SPhaseData phaseData; return phaseData; }
		virtual SPhaseData	VCOM_CALLTYPE GetViewportActivePhase(MCObjectHandle hViewport) override { SPhaseData phaseData; return phaseData; }

		virtual WorldCoord VCOM_CALLTYPE ObjVolumeInWorldCoords(MCObjectHandle h) override { return 0.0; }
	};
