...
bool VWPoint2D::operator==(const WorldPt& worldPt) const
{
   return this->Equal( worldPt, VWPoint2D::sEpsilon );
}
...
// rotate this point CW at specified angle in degrees and center point
...
// rotate this point CW at specified angle in radians and center point
...
// return perpendicular point of this point (rotated 90 degrees CW)
...
// set this point to the perpendicullar of the specified point (rotated 90 degrees CW)
...
// get the angle of this point's vector from -180 to 180 deg measured CCW from the positive x-axis.
...
// get the angle of this point's vector from 0 to 360 deg measured CCW from the positive x-axis.
