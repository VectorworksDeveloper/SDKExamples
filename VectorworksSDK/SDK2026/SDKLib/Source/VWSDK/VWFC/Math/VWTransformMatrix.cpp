...
void VWTransformMatrix::MirrorXYAfter()
{
	this->fMatrix.mat[0][2] *= -1;
	this->fMatrix.mat[1][2] *= -1;
	this->fMatrix.mat[2][2] *= -1;
	this->fMatrix.mat[3][2] *= -1;
}

void VWTransformMatrix::MirrorXZAfter()
{
	this->fMatrix.mat[0][1] *= -1;
	this->fMatrix.mat[1][1] *= -1;
	this->fMatrix.mat[2][1] *= -1;
	this->fMatrix.mat[3][1] *= -1;
}

void VWTransformMatrix::MirrorYZAfter()
{
	this->fMatrix.mat[0][0] *= -1;
	this->fMatrix.mat[1][0] *= -1;
	this->fMatrix.mat[2][0] *= -1;
	this->fMatrix.mat[3][0] *= -1;
}
