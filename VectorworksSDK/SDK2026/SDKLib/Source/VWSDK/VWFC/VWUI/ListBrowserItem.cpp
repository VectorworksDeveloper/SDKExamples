...
void VWListBrowserItem::SetItemIndentLevel(short level)
{
	VERIFYN(kAAntonini, gSDK->SetListBrowserItemIndentLevel(fDialogID, fControlID, fRowID, fColumnID, level));
}

short VWListBrowserItem::GetItemIndentLevel()
{
	short level;
	VERIFYN(kAAntonini, gSDK->GetListBrowserItemIndentLevel(fDialogID, fControlID, fRowID, fColumnID, level));
	return level;
}

void VWListBrowserItem::SetItemIndeterminate(bool indeterminate)
{
	VERIFYN(kAAntonini, gSDK->SetListBrowserItemIndeterminate(fDialogID, fControlID, fRowID, fColumnID, indeterminate));
}

bool VWListBrowserItem::GetItemIndeterminate()
{
	bool indeterminate;
	VERIFYN(kAAntonini, gSDK->GetListBrowserItemIndeterminate(fDialogID, fControlID, fRowID, fColumnID, indeterminate));
...
{
	ShowItemByClassOption(bShowByClass);
}
...
void VWListBrowserItem::SetItemResourceContent(VectorWorks::Extension::IResourceManagerContent* content)
{
	VERIFYN( kPBlanco, gSDK->SetListBrowserItemResourceContent( fDialogID, fControlID, fRowID, fColumnID, content ) );
}
...
void VWListBrowserItem::ShowItemByClassOption(bool bShowByClass)
{
	VERIFYN( kAAntonini, gSDK->ShowListBrowserItemByClassOption( fDialogID, fControlID, fRowID, fColumnID, bShowByClass ) );
}

void VWListBrowserItem::GetIsShowingItemByClassOption(bool bShowEditList)
{
	VERIFYN( kAAntonini, gSDK->GetShowListBrowserItemByClassOption( fDialogID, fControlID, fRowID, fColumnID, bShowEditList ) );
}

void VWListBrowserItem::SetItemByClass(bool bByClass)
{
	VERIFYN( kAAntonini, gSDK->SetListBrowserItemByClass( fDialogID, fControlID, fRowID, fColumnID, bByClass ) );
}

bool VWListBrowserItem::GetItemByClass(bool& bByClass) const
{
	bool result = gSDK->GetListBrowserItemByClass( fDialogID, fControlID, fRowID, fColumnID, bByClass );
	return result;
}
