...
: VWControl( id, {eCompResourceTextPopup} )
{
}
...
TXString VWResourceTextPopupCtrl::GetSelected()
{
	return gSDK->PullDownResourceLayoutGetSelectedResourceName(fpParentDlg->GetDialogID(), fControlID);
}

void VWResourceTextPopupCtrl::SetSelected(const TXString& name)
{
	gSDK->PullDownResourceLayoutSetSelectedResourceName(fpParentDlg->GetDialogID(), fControlID, name);
}

void VWResourceTextPopupCtrl::ClearSelected()
{
	TXString	empty;
	gSDK->PullDownResourceLayoutSetSelectedResourceName(fpParentDlg->GetDialogID(), fControlID, empty);
}
