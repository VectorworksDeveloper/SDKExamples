...
void VWChooseLayerPopupCtrl::InsertProposedLayer(const TXString& proposedLayer, const TXString& iconSpec /* = "" */)
{
	gSDK->InsertProposedClassOrLayerItem( fpParentDlg->GetControlID(), fControlID, proposedLayer, iconSpec);
}
...
void VWChooseLayerPopupCtrl::AddStaticChoice(const TXString& idName, const TXString& text, const TXString& toolTip, const TXString& iconSpec, bool shouldUpdate)
{
