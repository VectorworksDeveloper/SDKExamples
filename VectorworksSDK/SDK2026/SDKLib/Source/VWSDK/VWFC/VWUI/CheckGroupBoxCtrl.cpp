...
: VWControlsContainer( id, {eCompCheckBoxGroupBox} )
{
}
...
ECheckButtonCtrlState VWCheckGroupBoxCtrl::GetThreeState() const
{
	Sint32	state	= 0;
...
void VWCheckGroupBoxCtrl::SetThreeState(ECheckButtonCtrlState state)
{
