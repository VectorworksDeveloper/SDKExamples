...
// ---------------------------------------------------------------------------------------------------------------
VWCustomCtrlPen::VWCustomCtrlPen(EUiControlTextTint tint)
{
...
VWCustomCtrlPen::VWCustomCtrlPen(TGSColorV2 color)
{
	//	fStyle	= kCustomCtrlPenStyle_Solid;
	fSize	= 1;
	
	this->SetColor(color.GetGSColor());
}
...
void VWCustomCtrlPen::SetColor(EUiControlTextTint tint)
{
	this->SetColor(gSDK->GetControlTextColorByTint(tint));
}

void VWCustomCtrlPen::SetColor(GSColor color)
{
	fColor.AssignFrom(color);
}

void VWCustomCtrlPen::SetColor(TGSColorV2 color)
{
	fColor.AssignFrom(color.GetGSColor());
}
...
*/
// ---------------------------------------------------------------------------------------------------------------
VWCustomCtrlBrush::VWCustomCtrlBrush(EUiControlTextTint tint)
{
...
// ---------------------------------------------------------------------------------------------------------------
VWCustomCtrlBrush::VWCustomCtrlBrush(TGSColorV2 color)
{
	//	fStyle		= kCustomCtrlBrushStyle_Solid;
...
void VWCustomCtrlBrush::SetColor(EUiControlTextTint tint)
{
	this->SetColor(gSDK->GetControlTextColorByTint(tint));
}

void VWCustomCtrlBrush::SetColor(GSColor color)
{
	fColor.AssignFrom(color);
}
