...
VWControl::VWControl(TControlID id, const std::vector<VWControlType::EType>& allowedComponentTypes)
	: fControlID(id), fAllowedComponentTypes(allowedComponentTypes), fpParentDlg(nullptr)
{
}
