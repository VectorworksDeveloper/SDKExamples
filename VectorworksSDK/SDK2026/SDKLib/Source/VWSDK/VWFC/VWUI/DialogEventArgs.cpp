...
void VWListBrowserEventArgs::SetValidEditCompletionData()
{
	if (setmember( fData.fMessageDataId, kMessageQueryItemValue, kMessageQueryItemListRetrieval, kMessageItemEditCompletionData )) {
		fData.fReturnCode = 1;
	}
	else {
		DSTOP((kPBlanco, "This function is expected to be used only during EListBrowserDirectEditType::kMessageQueryItemValue, kMessageQueryItemListRetrieval or kMessageItemEditCompletionData"));
	}
}
