...
void CStandardEditTextBoxDlg::SetCancelBntText( const TXString& strCancelBntText )
{
	fstrCancelBntText = strCancelBntText;
}
...
void CStandardEditTextBoxDlg::SetLabelWidth(Sint16 ctrlWidth)
{
	fLabelWidth = ctrlWidth;
}
	...
	if ( isOK )
	{
		switch ( fDDXTypeDlg )
		{
			case EDlgValType::eDlgVal_String:
				{
					isOK	= isOK && fStaticTextCtrl.CreateControl( this, fstrLabel, fLabelWidth );
