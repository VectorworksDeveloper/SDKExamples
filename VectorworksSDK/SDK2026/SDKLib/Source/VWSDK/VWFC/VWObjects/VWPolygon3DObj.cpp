...
{
	if ( VWFC_VERIFY( VWPolygon3DObj::IsPolygon3DObject( hPoly3D ) ) )
	{
		fhObject	= hPoly3D;
	}
	else
...
bool VWPolygon3DObj::IsPolygon3DObject(MCObjectConstHandle hObj)
{
...
VWPolygon3D VWPolygon3DObj::GetPolygon() const
{
	VWPolygon3D poly;
