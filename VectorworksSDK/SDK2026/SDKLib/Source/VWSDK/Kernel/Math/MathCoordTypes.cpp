...
Degrees GS_API TransformMatrix::Get2DRotationAngle(const bool returnNegative /*= true*/) const
{
	Degrees rotationAngle = (DoubleIsNearlyZero(mat[0][0]) ? (mat[0][1] > 0 ? 90 : -90)
														   : (atan2(mat[0][1], mat[0][0]) * kDegreesPerRadian));

	if (rotationAngle < 0 && !returnNegative)
		rotationAngle += 360;
...
////////////////////////////////////////////////////////////////////////////////
bool GS_API TransformMatrix::IsOrthogonal(bool allow2DOrtho) const
//
...
/////// John Williams, 2 October 1999 //////////////////////////////////////////
{
	...
	if (row1.IsNormalized() && 
		row2.IsNormalized() &&
		(allow2DOrtho || (row3.IsNormalized() &&
