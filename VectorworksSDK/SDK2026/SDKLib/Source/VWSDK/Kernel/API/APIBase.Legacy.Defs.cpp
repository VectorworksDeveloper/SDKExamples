...
short GS_CALLBACK GS_GetObjectType(CALLBACKPTR, MCObjectConstHandle h)
{
	...
	if (f) {
		...
		#pragma pointers_in_D0
		#endif
		typedef CBSignedShort (*GetObjectTypePtr)(MCObjectConstHandle h);
...
MCObjectHandle GS_CALLBACK GS_FindDataObject(CALLBACKPTR, MCObjectConstHandle owner, OSType tag)
{
	...
	if (f) {
		...
		#pragma pointers_in_D0
		#endif
		typedef MCObjectHandle (*FindDataObjectPtr)(MCObjectConstHandle owner, OSType tag);
...
MCObjectHandle GS_CALLBACK GS_CreateCustomObjectByMatrix(CALLBACKPTR, const InternalName& name, const TransformMatrix& matrix)
{
	...
	if (f) {
		...
		#pragma pointers_in_D0
		#endif
		typedef MCObjectHandle (*CreateCustomObjectByMatrixPtr)(const InternalName& name, const TransformMatrix& matrix, bool bUseLegacyZ, bool doInsert);
		MCObjectHandle gsResult = CALL_PROC(CreateCustomObjectByMatrix)(name, matrix, true, true);
		#if GS_USE_D0_RETURNS
		#pragma pointers_in_A0
		#endif
		gCBP = saveCBP;
...
MCObjectHandle GS_CALLBACK GS_CreateCustomObjectPath(CALLBACKPTR, const InternalName& name, MCObjectHandle pathHand, MCObjectHandle profileGroupHand)
{
	...
	if (f) {
		...
		#pragma pointers_in_D0
		#endif
		typedef MCObjectHandle (*CreateCustomObjectPathPtr)(const InternalName& name, MCObjectHandle pathHand, MCObjectHandle profileGroupHand, bool bUseLegacyZ, bool doRegen);
		MCObjectHandle gsResult = CALL_PROC(CreateCustomObjectPath)(name, pathHand, profileGroupHand, true, true);
		#if GS_USE_D0_RETURNS
		#pragma pointers_in_A0
		#endif
		gCBP = saveCBP;
...
MCObjectHandle GS_CALLBACK GS_CreateGroup(CALLBACKPTR, bool isTemporary /* = false */)
{
	...
	if (f) {
		...
		#pragma pointers_in_D0
		#endif
		typedef MCObjectHandle (*CreateGroupPtr)(bool isTemporary);
		MCObjectHandle gsResult = CALL_PROC(CreateGroup)(isTemporary);
		#if GS_USE_D0_RETURNS
		#pragma pointers_in_A0
		#endif
		gCBP = saveCBP;
...
MCObjectHandle GS_CALLBACK GS_CreateLocus(CALLBACKPTR, const WorldPt& location, bool isTemporary)
{
	...
	if (f) {
		...
		#pragma pointers_in_D0
		#endif
		typedef MCObjectHandle (*CreateLocusPtr)(const WorldPt& location, bool isTemporary);
		MCObjectHandle gsResult = CALL_PROC(CreateLocus)(location, isTemporary);
		#if GS_USE_D0_RETURNS
		#pragma pointers_in_A0
		#endif
		gCBP = saveCBP;
...
MCObjectHandle GS_CALLBACK GS_CreateViewport(CALLBACKPTR, MCObjectHandle parentHandle)
{
	...
	if (f) {
		...
		#pragma pointers_in_D0
		#endif
		typedef MCObjectHandle (*CreateViewportPtr)(MCObjectHandle parentHandle, RefName viewportName);
...
Sint32 GS_CALLBACK GS_GetLayoutFromRsrc(CALLBACKPTR, short textRsrcID)
{
	...
	char resID[128]; 
	snprintf(resID, 128, "%s/DialogLayout/%d *", vwr, textRsrcID);
...
Sint32 GS_CALLBACK GS_RunLayoutDialog(CALLBACKPTR, Sint32 dialogID, GS_EventHandlerProcPtr handleEvent, void* env, const TXString& contextualHelpID)
{
	...
	if (f) {
		...
		#pragma pointers_in_D0
		#endif
		typedef Sint32 (*RunLayoutDialogPtr)(Sint32 dialogID, GS_EventHandlerProcPtr handleEvent, void* env, const TXString& contextualHelpID, bool enableContextualHelp);
		Sint32 gsResult = CALL_PROC(RunLayoutDialog)(dialogID, handleEvent, env, contextualHelpID, true);
		#if GS_USE_D0_RETURNS
		#pragma pointers_in_A0
		#endif
		gCBP = saveCBP;
...
MCObjectHandle GS_CALLBACK GS_CreateTextBlock(CALLBACKPTR, const TXString& textStr, const WorldPt& textOrigin, Boolean fixedSize, WorldCoord width)
{
	...
	if (f) {
		...
		#pragma pointers_in_D0
		#endif
		typedef MCObjectHandle (*CreateTextBlockPtr)(const TXString& textStr, const WorldPt& textOrigin, CBBoolean fixedSize, CBWorldCoord_param width, Boolean makeTemporary);
		MCObjectHandle gsResult = CALL_PROC(CreateTextBlock)(textStr, textOrigin, fixedSize, width, false);
		#if GS_USE_D0_RETURNS
		#pragma pointers_in_A0
		#endif
		gCBP = saveCBP;
...
void GS_CALLBACK GS_AttachDefaultTextureSpace(CALLBACKPTR, MCObjectHandle object, short multiPartID)
{
	...
	if (f) {
		...
		#pragma pointers_in_D0
		#endif
		typedef void (*AttachDefaultTextureSpacePtr)(MCObjectHandle object, CBSignedShort multiPartID, Sint32 categoryID);
		CALL_PROC(AttachDefaultTextureSpace)(object, multiPartID, 0);
		#if GS_USE_D0_RETURNS
		#pragma pointers_in_A0
		#endif
		gCBP = saveCBP;
...
void GS_CALLBACK GS_SetWorkspaceFileToReload(CALLBACKPTR, const TXString& inFileNameOrPath)
{
	...
	if (f) {
		...
		#pragma pointers_in_D0
		#endif
		typedef void (*SetWorkspaceFileToReloadPtr)(const TXString& inFileNameOrPath);
		CALL_PROC(SetWorkspaceFileToReload)(inFileNameOrPath);
		#if GS_USE_D0_RETURNS
		#pragma pointers_in_A0
		#endif
		gCBP = saveCBP;
