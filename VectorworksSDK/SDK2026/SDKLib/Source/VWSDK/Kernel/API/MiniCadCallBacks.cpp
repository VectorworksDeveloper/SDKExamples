...
//-----------------------------------------------------------------------------
CGSColorValueChange::CGSColorValueChange(const ColorRef newColor, const bool bColorByClass, const bool bShowByClass) :
    fNewColor(newColor),
	fbColorByClass(bColorByClass),
	fbShowByClass(bShowByClass)
{
}
...
//-----------------------------------------------------------------------------
//-----------------------------------------------------------------------------
CGSResourceValueChange::CGSResourceValueChange()
{
}
...
//-----------------------------------------------------------------------------
CGSLineWeightValueChange::CGSLineWeightValueChange(const short newLineWeight, const bool bWeightByClass, const bool bShowByClass) :
...
void CGSMenuItemCollection::operator=(const CGSMenuItemCollection& sourceMenuItemValue)
{
    ...
    for (const auto& currentItem : sourceMenuItemValue.fMenuItemCollection)
    {
...
//-----------------------------------------------------------------------------
bool CGSMenuItemValue::HasSubMenu() const
{
	return !fSubMenu.IsEmpty();
}

//-----------------------------------------------------------------------------
const CGSMenuItemCollection& CGSMenuItemValue::GetSubMenuItemCollection() const
{
	return fSubMenu;
}
...
//-----------------------------------------------------------------------------
bool CGSMenuItemValue::IsSeparator() const
{
	return fbIsSeparator;
}
...
const EMenuEnableFlags EMenuEnableFlags::None = EMenuEnableFlags(0);
const EMenuEnableFlags EMenuEnableFlags::DocIsActive = EMenuEnableFlags(1 << 0);
const EMenuEnableFlags EMenuEnableFlags::ProjectFileConnected = EMenuEnableFlags(1 << 1);
const EMenuEnableFlags EMenuEnableFlags::DocChanged = EMenuEnableFlags(1 << 2);
const EMenuEnableFlags EMenuEnableFlags::FilesLeft = EMenuEnableFlags(1 << 3);
const EMenuEnableFlags EMenuEnableFlags::DocOnDisk = EMenuEnableFlags(1 << 4);
const EMenuEnableFlags EMenuEnableFlags::HomeScreen = EMenuEnableFlags(1 << 5);
const EMenuEnableFlags EMenuEnableFlags::ObjectSelected = EMenuEnableFlags(1 << 7);
const EMenuEnableFlags EMenuEnableFlags::MultipleSelected = EMenuEnableFlags(1 << 8);
const EMenuEnableFlags EMenuEnableFlags::SelHas2D = EMenuEnableFlags(1 << 9);
const EMenuEnableFlags EMenuEnableFlags::SelHas3D = EMenuEnableFlags(1 << 10);
const EMenuEnableFlags EMenuEnableFlags::PlanProj = EMenuEnableFlags(1 << 11);
const EMenuEnableFlags EMenuEnableFlags::ActiveWorkingFile = EMenuEnableFlags(1 << 13);
const EMenuEnableFlags EMenuEnableFlags::SheetLayer = EMenuEnableFlags(1 << 14);
const EMenuEnableFlags EMenuEnableFlags::GetEnableStateFromMenuItem = EMenuEnableFlags(1 << 15);
