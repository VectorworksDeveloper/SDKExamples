...
namespace MockUp
{
	...
	public:
		...
		virtual void VCOM_CALLTYPE AddVertex(MCObjectHandle h, const WorldPt& p, VertexType t, WorldCoord arcRadius, Boolean recalcBounds) override
		{
		...
		virtual void VCOM_CALLTYPE SetVertex(MCObjectHandle h, short vertexNum, const WorldPt& vertex, VertexType vType, WorldCoord arcRadius, Boolean recalcBounds) override
		{
		...
		virtual MCObjectHandle VCOM_CALLTYPE CreateGroup() override
		{
				return NULL;
		}
		...
		virtual MCObjectHandle VCOM_CALLTYPE CreateLocus(const WorldPt& location) override
		{
				return NULL;
		}
		...
		virtual void VCOM_CALLTYPE AddObjectToContainer(MCObjectHandle h, MCObjectHandle container) override
		{
		...
		virtual void VCOM_CALLTYPE InsertObjectAfter(MCObjectHandle h, MCObjectHandle afterObject) override
		{
	
		}
		virtual void VCOM_CALLTYPE InsertObjectBefore(MCObjectHandle h, MCObjectHandle beforeObject) override
		{
	...
	public:
		...
		virtual short VCOM_CALLTYPE AddListBrowserImage(Sint32 dialogID, Sint32 componentID, const TXString& imageSpecifier, const TXString& selectedImageSpecifier) override
		{
			return 0;
		}
	...
	public:
		...
		virtual bool 			VCOM_CALLTYPE DisplayColorPopup(int top, int left, int bottom, int right, bool inDisplayByClassOption, ColorRef inClassColorRef, ColorRef& ioColorRef, bool& ioIsByClass) override { return false; }
		...
		virtual WallClosureGeometryInfo		VCOM_CALLTYPE GetWallClosureGeometryInfo(MCObjectHandle hObject, WorldCoord planHeight) override { return {}; };
