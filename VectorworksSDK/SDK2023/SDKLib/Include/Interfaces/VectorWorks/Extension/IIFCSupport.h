...
namespace VectorWorks
{
	namespace IFCLib
	{
		...
		namespace OIP
		{
		 ...
		 //---------------------------------------------------------------------------
		static const SImportRefDlgBehavior importRefDlgSettigsIFC = {
		...
		{
		public:
			IIFCSupport(): Filing::IImportReference( importRefDlgSettigsIFC ) { }
			...
			virtual VCOMError VCOM_CALLTYPE Import(IFileIdentifierPtr& fileID, const bool bShowUI, Sint16 importMode) override = 0;
