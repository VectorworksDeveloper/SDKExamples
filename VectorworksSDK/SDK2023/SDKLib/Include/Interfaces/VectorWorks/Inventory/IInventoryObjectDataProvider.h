...
namespace VectorWorks
{
	namespace Inventory
	{
		...
		public:
			...
			virtual SObjectParts			VCOM_CALLTYPE GetPartsValues( MCObjectHandle inObj ) = 0;
			virtual TXString				VCOM_CALLTYPE GetObjectUnifiedName( const SPartValuesArr& arr ) = 0;
			virtual TXString				VCOM_CALLTYPE GetPartUnifiedName( const SPartValue& part ) = 0;
			virtual TXString				VCOM_CALLTYPE GetVirtualPartsRecordName() = 0;
			virtual bool					VCOM_CALLTYPE EditParts( const TXString& partName, const SPartValuesArr& allParts ) = 0;
