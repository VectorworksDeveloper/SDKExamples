...
namespace VectorWorks
{
	namespace Filing
	{
		...
		// -----------------------------------------------------------------------------------
		static const SImportRefDlgBehavior importRefDlgSettigsDWG = {
		...
		{
		public:
			IImportExportDWG(): IImportReference( importRefDlgSettigsDWG ) { }
			...
			virtual VCOMError VCOM_CALLTYPE	Import(IFileIdentifierPtr& pFileID, const bool bShowUI, Sint16 importMode) override = 0;
