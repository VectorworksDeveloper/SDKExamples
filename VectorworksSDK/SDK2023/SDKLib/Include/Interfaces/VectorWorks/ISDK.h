...
//endif
	...
	public:
		...
		virtual bool			VCOM_CALLTYPE DisplayColorPopup(int top, int left, int bottom, int right, bool inDisplayByClassOption, ColorRef inClassColorRef, ColorRef& ioColorRef, bool& ioIsByClass) = 0;
		...
		virtual WallClosureGeometryInfo		VCOM_CALLTYPE GetWallClosureGeometryInfo(MCObjectHandle hObject, WorldCoord planHeight) = 0;
