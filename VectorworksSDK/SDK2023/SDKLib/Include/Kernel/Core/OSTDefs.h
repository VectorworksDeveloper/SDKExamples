...
#define OST_CreatorCode	'VW28'	// VectorWorks Application Creator Code; See VectorWorks.r, "plist" discussion for more information regarding changing creator codes.
