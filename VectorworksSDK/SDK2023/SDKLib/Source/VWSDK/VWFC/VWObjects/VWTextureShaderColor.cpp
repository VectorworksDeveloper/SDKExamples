...
{
	if ( VWFC_VERIFY( VWTextureShaderColorPlain::IsShaderRecordObject( hShaderRecord ) ) )
	{
...
{
	if ( VWFC_VERIFY( VWTextureShaderColorImage::IsShaderRecordObject( hShaderRecord ) ) )
	{
		fhObject	= hShaderRecord;
	}
	else
...
{
	if ( VWFC_VERIFY( VWTextureShaderColorFresnel::IsShaderRecordObject( hShaderRecord ) ) )
	{
		fhObject	= hShaderRecord;
	}
	else
...
{
	if ( VWFC_VERIFY( VWTextureShaderColorNoise::IsShaderRecordObject( hShaderRecord ) ) )
	{
		fhObject	= hShaderRecord;
	}
	else
...
{
	if ( VWFC_VERIFY( VWTextureShaderColorTiles::IsShaderRecordObject( hShaderRecord ) ) )
	{
		fhObject	= hShaderRecord;
	}
	else
...
{
	if ( VWFC_VERIFY( VWTextureShaderColorBricks::IsShaderRecordObject( hShaderRecord ) ) )
	{
		fhObject	= hShaderRecord;
	}
	else
...
{
	if ( VWFC_VERIFY( VWTextureShaderColorPavement::IsShaderRecordObject( hShaderRecord ) ) )
	{
		fhObject	= hShaderRecord;
	}
	else
