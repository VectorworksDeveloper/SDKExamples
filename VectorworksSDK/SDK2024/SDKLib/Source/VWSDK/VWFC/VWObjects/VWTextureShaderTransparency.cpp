...
{
	if ( VWFC_VERIFY( VWTextureShaderTransparencyPlain::IsShaderRecordObject( hShaderTransparency ) ) )
	{
...
{
	if ( VWFC_VERIFY( VWTextureShaderTransparencyColor::IsShaderRecordObject( hShaderTransparency ) ) )
	{
		fhObject	= hShaderTransparency;
	}
	else
...
{
	if ( VWFC_VERIFY( VWTextureShaderTransparencyImage::IsShaderRecordObject( hShaderTransparency ) ) )
	{
		fhObject	= hShaderTransparency;
	}
	else
...
{
	if ( VWFC_VERIFY( VWTextureShaderTransparencyGlass::IsShaderRecordObject( hShaderTransparency ) ) )
	{
		fhObject	= hShaderTransparency;
	}
	else
...
{
	if ( VWFC_VERIFY( VWTextureShaderTransparencyNoise::IsShaderRecordObject( hShaderTransparency ) ) )
	{
		fhObject	= hShaderTransparency;
	}
	else
...
{
	if ( VWFC_VERIFY( VWTextureShaderTransparencyTiles::IsShaderRecordObject( hShaderTransparency ) ) )
	{
		fhObject	= hShaderTransparency;
	}
	else
...
{
	if ( VWFC_VERIFY( VWTextureShaderTransparencyBricks::IsShaderRecordObject( hShaderTransparency ) ) )
	{
		fhObject	= hShaderTransparency;
	}
	else
...
{
	if ( VWFC_VERIFY( VWTextureShaderTransparencyPavement::IsShaderRecordObject( hShaderTransparency ) ) )
	{
		fhObject	= hShaderTransparency;
	}
	else
...
{
	if ( VWFC_VERIFY( VWTextureShaderTransparencyRectangularMask::IsShaderRecordObject( hShaderTransparency ) ) )
	{
		fhObject	= hShaderTransparency;
	}
	else
...
{
	if ( VWFC_VERIFY( VWTextureShaderTransparencyImageMask::IsShaderRecordObject( hShaderTransparency ) ) )
	{
		fhObject	= hShaderTransparency;
	}
	else
