...
//	fStyle	= kCustomCtrlPenStyle_Solid;
	...
	gSDK->GetProgramVariable(varIsDarkModeActive, &isDarkMode);
	if (isDarkMode)
	{
...
//	fStyle		= kCustomCtrlBrushStyle_Solid;
	...
	Boolean bIsDarkMode = false;
	gSDK->GetProgramVariable(varIsDarkModeActive, &bIsDarkMode);
	if (bIsDarkMode)
	{
#if GS_WIN
		this->SetColor( 48, 48, 48 );
#else
		this->SetColor( 35, 30, 41 );
#endif
	}
	else
	{
