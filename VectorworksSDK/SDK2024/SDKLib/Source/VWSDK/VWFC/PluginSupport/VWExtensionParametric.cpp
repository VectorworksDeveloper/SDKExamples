...
bool VWParametric_EventSink::OnGetInteractiveSizingParams(InteractiveSizingInformation& fInteractiveSizingInfo /* vector of SInteractiveSizingParameterInfo */)
{
	return false;
}

bool VWParametric_EventSink::OnSetInteractiveSizingParams(const InteractiveSizingInformation& fInteractiveSizingInfo /* vector of SInteractiveSizingParameterInfo */)
{
	return false;
}
