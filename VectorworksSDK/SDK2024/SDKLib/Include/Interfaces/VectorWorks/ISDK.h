...
namespace VectorWorks
{
	...
	public:
		...
		virtual double_gs VCOM_CALLTYPE CalcSurfaceArea(MCObjectHandle h) = 0;	// returns squared document LENGTH units. For area units use ObjSurfaceArea
		...
		virtual double_gs VCOM_CALLTYPE ObjSurfaceArea(MCObjectHandle h) = 0;	// return document area units
...
//endif
    ...
    public:
		...
		virtual bool			VCOM_CALLTYPE FormatTextObjectInSIA(MCObjectHandle hText, const TXString& centimeters, const TXString& millimeters) = 0;
		virtual bool			VCOM_CALLTYPE FormatTextObjectSegmentInSIA(MCObjectHandle hText, size_t startIndex, size_t countChars) = 0;
	...
	public:
		...
		virtual bool	VCOM_CALLTYPE IsActiveFileChangedAfterLastSave() = 0;
