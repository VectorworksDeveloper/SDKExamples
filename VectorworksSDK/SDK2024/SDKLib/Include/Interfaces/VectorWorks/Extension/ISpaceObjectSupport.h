...
namespace VectorWorks
{
	namespace Extension
	{
		enum class ESpaceTagStyleDeleteAction
		{
			None,
			CancelStyleDelete,
		};
		...
		public:
			...
			virtual ESpaceTagStyleDeleteAction VCOM_CALLTYPE OnDataTagStyleDelete( MCObjectHandle dataTagStyle, const TMCObjectHandlesSTLArray& objectsToDelete, bool showAlert ) = 0;
		};
	}
}
