...
namespace VWFC
{
	namespace Math
	{
		...
		protected:
			...
			{
									SVertex();
									SVertex(const SVertex& src) = default;
									SVertex(SVertex&& src) = default;
				virtual				~SVertex() = default;

				// operators.
				SVertex&			operator=(const SVertex& src) = default;
				SVertex&			operator=(SVertex&& src) = default;
