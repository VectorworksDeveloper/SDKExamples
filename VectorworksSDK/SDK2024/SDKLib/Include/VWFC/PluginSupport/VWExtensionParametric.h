	...
	namespace PluginSupport
	{
		...
		public:
			...
			*/
			...
			virtual bool			OnGetInteractiveSizingParams(InteractiveSizingInformation& fInteractiveSizingInfo /* vector of SInteractiveSizingParameterInfo */);
			virtual bool			OnSetInteractiveSizingParams(const InteractiveSizingInformation& fInteractiveSizingInfo /* vector of SInteractiveSizingParameterInfo */);
