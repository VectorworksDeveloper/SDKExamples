...
void CSampleDlg4::OnButtonCtrl(long controlID, VWDialogEventArgs& eventArgs)
{
	CMyDialog dlg; 
	dlg.RunDialogLayout( "" ); 
}

void CSampleDlg4::OnColorButton(long controlID, VWDialogEventArgs& eventArgs)
{
...
void CSampleDlg4::OnColorPopup(long controlID, VWDialogEventArgs& eventArgs)
{
...
void CSampleDlg4::OnLefButton(long controlID, VWDialogEventArgs& eventArgs)
{
...
void CSampleDlg4::OnHatchesRadio(long controlID, VWDialogEventArgs& eventArgs)
{
	this->FillThumbnail( kThumbnailType_Hatches );
}

void CSampleDlg4::OnWallHatchesRadio(long controlID, VWDialogEventArgs& eventArgs)
{
	this->FillThumbnail( kThumbnailType_WallHatches );
}

void CSampleDlg4::OnGradientsRadio(long controlID, VWDialogEventArgs& eventArgs)
{
	this->FillThumbnail( kThumbnailType_Gradients );
}

void CSampleDlg4::OnImagesRadio(long controlID, VWDialogEventArgs& eventArgs)
{
	this->FillThumbnail( kThumbnailType_LineStyle );
}

void CSampleDlg4::OnGetThumbnailButton (long controlID, VWDialogEventArgs& eventArgs)
{
	VWThumbnailPopupCtrl*	pThumbnail		= this->GetThumbnailPopupCtrlByID( kThumbNailCtrl );
...
void CSampleDlg4::OnSetThumbnailButton(long controlID, VWDialogEventArgs& eventArgs)
{
