...
bool VWStyleSupport::GetStyleType(const TXString& key, EPluginStyleParameter & styleType )
{
	bool bReturn = true;
	styleType = kPluginStyleParameter_ByInstance;
...
bool VWStyleSupport::AddItem( const TXString& key, EPluginStyleParameter styleType )
{
	if ( fhHostSymbolDefiniiton == NULL ) {
		return false;
	}
