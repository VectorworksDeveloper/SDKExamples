...
EVENT_DISPATCH_MAP_BEGIN( VWSwapPaneCtrl );
...
void VWSwapPaneCtrl::OnDDXInitialize()
{
}

void VWSwapPaneCtrl::OnSetUpEvent()
{
}

void VWSwapPaneCtrl::OnSetDownEvent()
{
}

void VWSwapPaneCtrl::OnUpdateUI()
{
}

bool VWSwapPaneCtrl::CanEnableOK()
{
	return true;
}
