...
{
	SymbolImgInfo imgInfoIn( width, height, margin, standardViewRightIso, renderSolid, EImageViewComponent::NotSet, false /*scaleByZoom*/);
...
{
	SymbolImgInfo imgInfoIn(view, renderMode, EImageViewComponent::NotSet, false /*scaleByZoom*/);
