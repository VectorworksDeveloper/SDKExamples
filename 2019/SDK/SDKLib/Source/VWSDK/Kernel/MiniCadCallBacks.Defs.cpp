...
MCObjectHandle GS_CALLBACK GS_GetCustomObjectProfileGroup(CALLBACKPTR, MCObjectHandle objectHand)
{
	...
	if (f) {
		...
		#pragma pointers_in_D0
		#endif
		typedef MCObjectHandle (*GetCustomObjectProfileGroupPtr)(MCObjectHandle objectHand);
		MCObjectHandle gsResult = CALL_PROC(GetCustomObjectProfileGroup)(objectHand);
		#if GS_USE_D0_RETURNS
		#pragma pointers_in_A0
		#endif
		gCBP = saveCBP;
...
void GS_CALLBACK GS_MoveObject3D(CALLBACKPTR, MCObjectHandle h, WorldCoord dx, WorldCoord dy, WorldCoord dz)
{
	...
	if (f) {
		...
		#pragma pointers_in_D0
		#endif
		typedef void (*MoveObject3DPtr)(MCObjectHandle h, CBWorldCoord_param dx, CBWorldCoord_param dy, CBWorldCoord_param dz);
		CALL_PROC(MoveObject3D)(h, dx, dy, dz);
		#if GS_USE_D0_RETURNS
		#pragma pointers_in_A0
		#endif
		gCBP = saveCBP;
