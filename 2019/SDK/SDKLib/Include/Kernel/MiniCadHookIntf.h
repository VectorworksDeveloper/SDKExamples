...
const ToolPropID kToolEnablePickDeepInViewportAnnotatonsMode = 6;		// tool want to pick deep inside viewport annotations.
...
//													 //						//
//---------------------------------------------------//---------------------//-------------------------------------------------------------------------------------------------
const ObjectPropID kLastObjXProp = kObjXPropShowDetailWidgetsInProfileGroup;// last property ID
//---------------------------------------------------//---------------------//-------------------------------------------------------------------------------------------------																			//---------------------------------------------------//---------------------//-------------------------------------------------------------------------------------------------
...
typedef Sint32					TNotThreadSafeRefNum;
typedef std::atomic<Sint32>		TThreadSafeRefNum;

// VCOM interface implementation with late destruction
template<class Interface, class RefNumType=TNotThreadSafeRefNum> class VCOMImpl : public Interface
{
public:
...
template<class Interface, class RefNumType=TNotThreadSafeRefNum> class VCOMImmediateImpl : public Interface
{
public:
