...
#define OST_CreatorCode	'VW24'	// VectorWorks 24 Application Creator Code; See VectorWorks.r, "plist" discussion for more information regarding changing creator codes.
...
#define OST_StationeryFileType OST_sW24
