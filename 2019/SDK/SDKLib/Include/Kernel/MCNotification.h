...
const Sint32 kNotifyMaterialChange		= 'MaCh';		// Send when a material node has been added, deleted, or edited
...
const Sint32 kNotifyRoofStyleChange		= 'RlCh';		// Send when a Slab Style has been added, deleted, or edited
