...
namespace VWFC
{
	namespace PluginSupport
	{
		...
		private:
			...
			typedef std::map<SSTRResource, TXString>				TResStringCache;
			typedef std::map<SResString, TXString>					TResStringCache_;
			typedef std::map<short, const SParametricParamChc_Legacy*>		TChcCache;
			typedef std::map<short, const SParametricParamChc*>	TChcCache_;
		...
		private:
			// -------------------------------------------------------------------
			class CParametersProvider : public VCOMImpl<IParametricParamsProvider>
			{
			public:
			...
			public:
				...
				virtual void VCOM_CALLTYPE				GetParamDefValueImperial(size_t paramIndex, TXString& outValue);
				virtual void VCOM_CALLTYPE				GetParamDefValueMetric(size_t paramIndex, TXString& outValue);
