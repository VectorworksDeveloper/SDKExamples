	...
	namespace VWUI
	{
		...
		public:
			...
			********************************************************************/
			...
			void	AddDDX_StaticText(TControlID controlID, TXString* pValue, const  TXString& key = "");
		...
		protected:
			virtual void DispatchEvent(TControlID controlID, VWDialogEventArgs& eventArg);
		...
		protected:
			...
			void				UpdateDataInternal(bool bSafeToUI, TControlID id, bool onlyThisOne);
		...
		protected:
			...
			// tab panes for which this dialog will pass data
			void*				fpArrTabPanes;
			...
			TXString			fByInstacneButtonHelp;
		};
