...
namespace VWFC
{
	namespace Math
	{
		...
		public:
			...
			bool			GetSegment(size_t segIndex, VWLine2D& outSegLine, VWArc2D& outSegArc, bool& outIsArc, bool& outIsLine, bool recursion = true);
		...
		public:
			...
			void			GetPolygonized(	VWPolygon2D& outPolygon,
											...
											std::function<void(size_t inpuIndex, size_t outputIndexStart, size_t outputIndexEnd)> callbackAddSegment = nullptr) const;

			// check if it is an equalish polygon
			bool			EqualishTo(const VWPolygon2D& poly) const;
		...
		protected:
			bool		GetArcFromArcPolyAt(size_t at, VWArc2D& outArc);
		...
		protected:
			...
			void			PolygonizeArc(const VWPoint2D& lastPt, const VWPoint2D& thisPt, const VWPoint2D& nextPt, double radius, VWPolygon2D& outPolygon) const;
			void			PolygonizeArc(const VWPoint2D &lastPt, const VWPoint2D& nextPt, double radius, VWPoint2D& lastCam, VWPoint2D& thisCam, VWPoint2D& center, double theStart, double theArc, VWPolygon2D& outPolygon) const;
			void			PolygonizeArcSegment(double inStart, double inArc, const VWPoint2D& cen, double radius, VWPolygon2D& outPolygon) const;
