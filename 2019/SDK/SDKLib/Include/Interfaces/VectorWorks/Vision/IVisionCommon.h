...
namespace VectorWorks {
	...
	public:
		...
		virtual void                 SetSymbolNameSource(const TXString& symbolNameSource) = 0;
		virtual void                 SetUniverseSource(const TXString& universeSource) = 0;
		virtual void                 SetChannelSource(const TXString& channelSource) = 0;
		virtual void                 SetUnitNumberSource(const TXString& unitNumberSource) = 0;
		...
		///@note XML Parsing helper
		class IXMLHelper
		{
		public:
			virtual ~IXMLHelper(){};
			virtual bool LoadDataSources(QDomElement *e) = 0;
			virtual bool LoadElement(QDomElement *e) = 0;
			virtual bool LoadDocument(const char *filename) = 0;
		};
		virtual IXMLHelper* XMLHelperInstance() = 0;
