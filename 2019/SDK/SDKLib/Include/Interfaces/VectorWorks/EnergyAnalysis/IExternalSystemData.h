...
namespace VectorWorks
{
	namespace EnergyAnalysis
	{
		...
		public:
			virtual void	VCOM_CALLTYPE WidgetUI_Fill(IWidgetDataPopup* widgetPopup, TXString& outItemID) = 0;
			virtual void	VCOM_CALLTYPE WidgetUI_Select(IWidgetDataPopup* widgetPopup, const TXString& itemID) = 0;
		};
