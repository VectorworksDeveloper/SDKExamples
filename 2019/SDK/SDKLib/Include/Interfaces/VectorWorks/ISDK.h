...
namespace VectorWorks
{
	...
	public:
		...
		virtual void VCOM_CALLTYPE MoveObject3D(MCObjectHandle h, WorldCoord dx, WorldCoord dy, WorldCoord dz) = 0;
...
//endif
	...
	public:
		...
		virtual Sint32			VCOM_CALLTYPE CallDefaultTool(ToolMessage* message, void*& messageContext) = 0;
	...
	public:
		...
		virtual Sint32			VCOM_CALLTYPE CallDefaultToolN(EDefaultToolType type, bool isStandard, ToolMessage* message, void*& messageContext) = 0;
	...
	public:
		...
		virtual MCObjectHandle	VCOM_CALLTYPE FindWallsSurroundingPoint(MCObjectHandle inBoundedObject, const WorldPt& inPoint, short inColumnsAndPilastersEnum,
				MCObjectHandle inListOfObjects, bool ignoreClassVisibility) = 0;
		...
		virtual Boolean			VCOM_CALLTYPE IsWorksheetCellImage (MCObjectHandle worksheet, short row, short column) = 0;
		...
		virtual MCObjectHandle	VCOM_CALLTYPE AssociateBoundedObjectWithWalls(MCObjectHandle inBoundedObject, TVWArray_MCObjectHandle& wallList, short inColumnsAndPilastersEnum) = 0;
	...
	public:
		...
		virtual void				VCOM_CALLTYPE ConvertToGroup(MCObjectHandle object, short convertAction) = 0;
        ...
        virtual bool                VCOM_CALLTYPE GetProjectFullPath(IFileIdentifier** ppOutFileID) = 0;
