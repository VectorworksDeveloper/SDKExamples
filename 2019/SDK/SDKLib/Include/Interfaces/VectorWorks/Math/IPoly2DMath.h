...
namespace VectorWorks
{
	namespace Math
	{
		...
		public:
			...
			virtual bool				VCOM_CALLTYPE SplitPolyline(MCObjectHandle & object, WorldPt  pickPt, MCObjectHandle & object1, MCObjectHandle & object2) = 0;
			virtual MCObjectHandle		VCOM_CALLTYPE ClipPolyline(MCObjectHandle blank, MCObjectHandle tool)=0;
