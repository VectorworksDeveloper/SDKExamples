...
namespace VectorWorks
{
	namespace Extension
	{
		...
		struct SResourceProperties {
				...
				std::unique_ptr <bool>		srpSimple;		// for Line types only
		...
		public:
			...
			virtual MCObjectHandle	ImportSelectedResourceToCurrentFile(VectorWorks::EImportResourceConflictResult resolveConflicts) = 0;
