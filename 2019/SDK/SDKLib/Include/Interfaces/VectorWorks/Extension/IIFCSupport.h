...
namespace VectorWorks
{
	namespace IFCLib
	{
		...
		public:
			...
			virtual VCOMError VCOM_CALLTYPE ImportFile(IFileIdentifier* pFileID, bool bShowUI) = 0;
			...
			virtual VCOMError VCOM_CALLTYPE IFC_CreateObjectGUID(MCObjectHandle hObject, bool bDoUndo = true) = 0;
