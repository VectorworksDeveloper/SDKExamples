...
namespace VectorWorks
{
	namespace Extension
	{
		...
		public:
			...
			virtual VCOMPtr<IEventSink>	VCOM_CALLTYPE QueryExtensionEvenSink(MCObjectHandle hParametric, TSinkIID sinkGroupIID) = 0; 
            virtual VCOMPtr<IEventSink>	VCOM_CALLTYPE QueryExtensionEventSink(const TXString& universalName, const TSinkIID& sinkGroupIID) = 0;
